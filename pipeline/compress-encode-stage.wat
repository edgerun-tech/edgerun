;; Gzip/Zlib Encode Pipeline Stage — slots 30, 32
  ...
  (func $compress_encode (export "process_gzip_encode")
    (param $input i32) (param $output i32) (param $cfg i32) (param $clen i32)
    (param $scratch i32) (param $scap i32) (param $state i32) (result i32)
    (local $read i32)
    (local $result i64) (local $status i32) (local $checksum i32)
    (local $out_len i32) (local $header_len i32) (local $comp_len i32)
    ...
    (local.set $checksum (call $crc32 (global.get $SCRATCH_BUF) (local.get $read)))
  ...
  (func $compress_encode_zlib (export "process_zlib_encode")
    (param $input i32) (param $output i32) (param $cfg i32) (param $clen i32)
    (param $scratch i32) (param $scap i32) (param $state i32) (result i32)
    (local $read i32)
    (local $result i64) (local $status i32) (local $checksum i32)
    ...
    (if (local.get $status) (then (return (i32.sub (i32.const 0) (local.get $status)))))
    (local.set $comp_len (i32.wrap_i64 (local.get $result)))
    (local.set $checksum (call $adler32 (global.get $SCRATCH_BUF) (local.get $read)))
    (local.set $out_len (i32.add (local.get $header_len) (local.get $comp_len)))
