...
#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserHostResultRecord {
    pub abi_version: u16,
    pub status: u16,
    pub output: Vec<u8>,
...
#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserHostStorageInvocationRecord {
    pub abi_version: u16,
...
#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserAppFirstRunInputRecord {
    pub abi_version: u16,
    pub flags: u32,
    pub profile_id: [u8; 32],
...
#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserAppFirstRunProjectionRecord {
    pub abi_version: u16,
    pub flags: u32,
...
#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserPackageRetrievalRecord {
    pub abi_version: u16,
    pub flags: u32,
    ...
    pub package_sha256: [u8; 32],
    pub manifest_sha256: [u8; 32],
    pub developer_signature_sha256: [u8; 32],
    pub manifest_bytes: u64,
    pub graph_bytes: u64,
    pub developer_signature_bytes: u64,
    pub retrieval_cost: u64,
    pub retrieved_at: u64,
    pub source_admission_hash: [u8; 32],
    pub retrieval_evidence_sha256: [u8; 32],
    pub proof_sha256: [u8; 32],
}

#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserPackageRetrievalEvidenceRecord {
    pub abi_version: u16,
    pub flags: u32,
    pub package_key: Vec<u8>,
    pub package_sha256: [u8; 32],
    pub manifest_sha256: [u8; 32],
    pub work_request_hash: [u8; 32],
    ...
    pub user_id: [u8; 32],
    pub admission_node_id: [u8; 32],
    pub storage_node_id: [u8; 32],
    pub admitted_budget: u64,
    pub retrieval_cost: u64,
    pub requested_at: u64,
    pub admitted_until: u64,
}

#[derive(Clone, Debug, PartialEq, Eq, Archive, Serialize, Deserialize)]
#[rkyv(crate = rkyv)]
pub struct BrowserPackageRetrievalPolicyScheduleRecord {
    pub abi_version: u16,
    pub flags: u32,
...
pub enum SdkWireRecord {
    ...
    BrowserAppFirstRunInput(BrowserAppFirstRunInputRecord),
    BrowserAppFirstRunProjection(BrowserAppFirstRunProjectionRecord),
    BrowserPackageRetrieval(BrowserPackageRetrievalRecord),
    BrowserPackageRetrievalEvidence(BrowserPackageRetrievalEvidenceRecord),
    BrowserPackageRetrievalPolicySchedule(BrowserPackageRetrievalPolicyScheduleRecord),
    ...
    BrowserHostResult(BrowserHostResultRecord),
    BrowserHostStorageInvocation(BrowserHostStorageInvocationRecord),
...
mod tests {
    ...
    #[test]
    fn browser_host_records_archive_through_rkyv() {
        let result = BrowserHostResultRecord {
            abi_version: SDK_WIRE_ABI_VERSION,
            status: 0,
            output: b"ok".to_vec(),
            proof_hashes: vec![[9; 32]],
        };
        let bytes = sdk_wire_bytes(&SdkWireRecord::BrowserHostResult(result));
        assert!(!bytes.is_empty());
        ...
        let bytes = sdk_wire_bytes(&SdkWireRecord::BrowserHostStorageInvocation(invocation));
        assert!(!bytes.is_empty());
    }
    ...
    fn node_admission_cache_and_run_prompt_records_archive() {
        ...
        let retrieval = BrowserPackageRetrievalRecord {
            abi_version: SDK_WIRE_ABI_VERSION,
            flags: 1,
            package_key: b"apps/example".to_vec(),
            app_id: [2; 32],
            release_id: [3; 32],
            developer_id: [10; 32],
            package_sha256: [4; 32],
            manifest_sha256: [5; 32],
            developer_signature_sha256: [11; 32],
            manifest_bytes: 128,
            graph_bytes: 256,
            developer_signature_bytes: 64,
            retrieval_cost: 33,
            retrieved_at: 42,
            source_admission_hash: [7; 32],
            retrieval_evidence_sha256: [12; 32],
            proof_sha256: [13; 32],
        };
        let retrieval_evidence = BrowserPackageRetrievalEvidenceRecord {
            abi_version: SDK_WIRE_ABI_VERSION,
            flags: 1,
            package_key: b"apps/example".to_vec(),
            package_sha256: [4; 32],
            manifest_sha256: [5; 32],
            work_request_hash: [14; 32],
            admission_hash: [15; 32],
            route_commitment: [16; 32],
            channel_id: [17; 32],
            policy_hash: [18; 32],
            user_id: [19; 32],
            admission_node_id: [20; 32],
            storage_node_id: [21; 32],
            admitted_budget: 100,
            retrieval_cost: 33,
            requested_at: 42,
            admitted_until: 420,
        };
        let retrieval_schedule = BrowserPackageRetrievalPolicyScheduleRecord {
            abi_version: SDK_WIRE_ABI_VERSION,
            flags: 1,
            schedule_id: [22; 32],
            policy_hash: [18; 32],
        ...
        assert!(!sdk_wire_bytes(&SdkWireRecord::BrowserPackageRetrieval(retrieval)).is_empty());
        assert!(
            !sdk_wire_bytes(&SdkWireRecord::BrowserPackageRetrievalEvidence(
                retrieval_evidence
            ))
            .is_empty()
        );
        assert!(
            !sdk_wire_bytes(&SdkWireRecord::BrowserPackageRetrievalPolicySchedule(
                retrieval_schedule
            ))
            .is_empty()
        );
