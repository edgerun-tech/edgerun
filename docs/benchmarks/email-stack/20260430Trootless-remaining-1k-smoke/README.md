...
Captured at: 2026-04-30T03:28:22Z
...
- Edgerun rootless Podman: 1000 local-only SMTP loopback deliveries and
  100 IMAP login/list/select/logout sessions, concurrency 32.
- SMTP-only stacks: 1000 local-only loopback deliveries, concurrency
...
- Stack selection: `opensmtpd exim dovecot`. Override with EDGERUN_EMAIL_STORY_STACKS to run
