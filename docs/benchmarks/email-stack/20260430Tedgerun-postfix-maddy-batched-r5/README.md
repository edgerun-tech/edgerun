...
Captured at: 2026-04-30T06:40:27Z
...
- Protocol commands have a 180 second wall-clock cap. A timeout is
...
- Measured repetitions per workload: 5.
...
- Native Edgerun snapshot: disabled by default. Set
  ...
  fallback.
- Stack selection: `edgerun postfix maddy`. Override with EDGERUN_EMAIL_STORY_STACKS to run
