...
3. Profile mode no longer relies on plain localStorage token values for integration connectivity.
4. Tailscale API/auth keys follow encrypted profile secret path in profile mode.
5. Frontend check/build and targeted Cypress integration specs pass.
