...
export type McpElicitationEnumSchema = { "SingleSelect": McpElicitationSingleSelectEnumSchema } | { "MultiSelect": McpElicitationMultiSelectEnumSchema } | { "Legacy": McpElicitationLegacyTitledEnumSchema };
