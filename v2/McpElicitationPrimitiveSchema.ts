...
export type McpElicitationPrimitiveSchema = { "Enum": McpElicitationEnumSchema } | { "String": McpElicitationStringSchema } | { "Number": McpElicitationNumberSchema } | { "Boolean": McpElicitationBooleanSchema };
