...
export type HookRunSummary = { id: string, event_name: HookEventName, handler_type: HookHandlerType, execution_mode: HookExecutionMode, scope: HookScope, source_path: AbsolutePathBuf, source: HookSource, display_order: bigint, status: HookRunStatus, status_message: string | null, started_at: bigint, completed_at: bigint | null, duration_ms: bigint | null, entries: Array<HookOutputEntry>, };
