 ...
 */
export type ItemGuardianApprovalReviewCompletedNotification = { thread_id: string, turn_id: string, 
/**
 ...
 */
target_item_id: string | null, decision_source: AutoReviewDecisionSource, review: GuardianApprovalReview, action: GuardianApprovalReviewAction, };
