...
- `OrgFdroidFdroidPanicCalculatoractivity` routes to `org.fdroid.fdroid.panic.CalculatorActivity` (activity)
  - Android action `android.intent.action.MAIN`
- `OrgFdroidFdroidViewsReposAddrepoactivity` routes to `org.fdroid.fdroid.views.repos.AddRepoActivity` (activity)
  - Android action `android.intent.action.SEND`
  - Android action `android.intent.action.VIEW`
- `OrgFdroidFdroidViewsAppdetailsactivity` routes to `org.fdroid.fdroid.views.AppDetailsActivity` (activity)
...
- `org.fdroid.fdroid.views.repos.AddRepoActivity` -> `onCreate` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
  - `background_tasks.schedule_or_handle_background_work` from `work_background` evidence
- `org.fdroid.fdroid.views.repos.AddRepoActivity` -> `onFetchRepo` records:
  - `network.request_network_or_webview` from `network_web` evidence
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
- `org.fdroid.fdroid.views.repos.AddRepoActivity` -> `onCreate$lambda$2` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
- `org.fdroid.fdroid.views.AppDetailsActivity` -> `onCreate` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
- `org.fdroid.fdroid.views.AppDetailsActivity` -> `onActivityResult` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
- `org.fdroid.fdroid.views.AppDetailsActivity` -> `onOptionsItemSelected` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
  - `network.request_network_or_webview` from `network_web` evidence
- `org.fdroid.fdroid.views.AppDetailsActivity` -> `updateAppStatus` records:
  - `app_events.send_or_receive_app_event` from `package_intents` evidence
