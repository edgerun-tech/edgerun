...
pub const SOURCE_CLASS: &str = "com.google.android.googlequicksearchbox.SearchWidgetProvider";
...
fn onreceive(state: &mut AppState, capabilities: &Capabilities) {
    let _ = state;
    let _ = capabilities;
    // Source method: com.google.android.googlequicksearchbox.SearchWidgetProvider->onReceive
...
fn init(state: &mut AppState, capabilities: &Capabilities) {
    let _ = state;
    let _ = capabilities;
    // Source method: com.google.android.googlequicksearchbox.SearchWidgetProvider-><init>
