...
pub const SOURCE_CLASS: &str = "com.google.android.gms.accountsettings.ui.SettingsLoaderActivity";
...
fn init(state: &mut AppState, capabilities: &Capabilities) {
    let _ = state;
    let _ = capabilities;
    // Source method: com.google.android.gms.accountsettings.ui.SettingsLoaderActivity-><init>
