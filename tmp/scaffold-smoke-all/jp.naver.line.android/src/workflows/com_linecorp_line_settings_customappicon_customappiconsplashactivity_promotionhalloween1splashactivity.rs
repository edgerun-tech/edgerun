...
pub const SOURCE_CLASS: &str = "com.linecorp.line.settings.customappicon.CustomAppIconSplashActivity$PromotionHalloween1SplashActivity";
...
fn init(state: &mut AppState, capabilities: &Capabilities) {
    let _ = state;
    let _ = capabilities;
    // Source method: com.linecorp.line.settings.customappicon.CustomAppIconSplashActivity$PromotionHalloween1SplashActivity-><init>
