...
- Unique API signatures: `7670`
- Static call sites: `106321`
...
- `bluetooth_nearby`: 31 call sites; Bluetooth or nearby-device discovery/connect behavior
- `camera_media_capture`: 866 call sites; camera, microphone, recorder, or media capture behavior
- `contacts_calendar`: 33 call sites; contacts or calendar provider access
- `crypto_security`: 897 call sites; key, certificate, cipher, signature, or keystore behavior
...
- `network_web`: 1171 call sites; network, socket, HTTP, TLS, or WebView behavior
- `notifications`: 91 call sites; notification posting, channels, or listener behavior
- `package_intents`: 4813 call sites; intent, package manager, broadcast, or cross-app behavior
...
- `work_background`: 6359 call sites; jobs, alarms, wake locks, services, or background work
...
- Resource buckets: `color`(266) `color-v31`(62)
