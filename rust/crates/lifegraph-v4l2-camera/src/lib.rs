...
impl CameraBiometricReader for V4l2CameraBiometricReader {
    ...
    fn begin_enrollment(
        &mut self,
        request: &lifegraph_camera_biometrics::CameraEnrollRequest,
    ) -> Result<CameraEnrollmentSession, CameraBiometricError> {
        lifegraph_camera_biometrics::validate_camera_enroll_request(request)?;
...
impl V4l2PairedCameraBiometricReader {
    ...
    fn default_liveness_state(passed: bool) -> lifegraph_biometrics::BiometricState {
