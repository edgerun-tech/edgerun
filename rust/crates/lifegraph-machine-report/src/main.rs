use lifegraph_machine_report::{gather_machine_report, render_machine_report, OutputFormat};

fn usage() {
    eprintln!("usage: lifegraph-machine-report [text|json|--format <text|json>]");
}
