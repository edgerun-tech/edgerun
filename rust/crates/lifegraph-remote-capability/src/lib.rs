...
use lifegraph_camera_biometrics::{
...
use lifegraph_capabilities::{CapabilityDescriptor, CapabilityError};
use lifegraph_capability_policy::{
    PolicyContext, PolicyDecision, PolicyEngine, RevocationReason, SimplePolicyEngine,
};
use lifegraph_input::{InputDevice, InputEventKind, InputEventRecord};
...
pub use lifegraph_proto::lifegraph::v0::capability_runtime::{
...
impl<P> PolicyWrappedProvider<P> {
    ...
    fn request_for_open(
        ...
        open: &CapabilitySessionOpen,
    ) -> lifegraph_capabilities::CapabilityRequest {
...
) -> lifegraph_capabilities::CapabilitySelector {
    lifegraph_capabilities::CapabilitySelector {
...
pub fn default_remote_requester() -> lifegraph_proto::lifegraph::v0::common::IdentityRef {
    lifegraph_proto::lifegraph::v0::common::IdentityRef {
...
fn default_remote_requester_opt() -> Option<lifegraph_proto::lifegraph::v0::common::IdentityRef> {
...
pub fn session_open_as_request(
    open: &CapabilitySessionOpen,
    descriptor: &CapabilityDescriptor,
    requester: Option<lifegraph_proto::lifegraph::v0::common::IdentityRef>,
    requester_node: Option<lifegraph_proto::lifegraph::v0::common::NodeRef>,
) -> lifegraph_capabilities::CapabilityRequest {
    lifegraph_capabilities::CapabilityRequest {
...
pub fn session_accept_from_grant(
    open: &CapabilitySessionOpen,
    grant: &lifegraph_capabilities::CapabilityGrant,
...
pub fn encode_camera_capture(capture: &CameraCapture) -> Vec<u8> {
    ...
    out.push(match capture.state.modality {
        Some(lifegraph_biometrics::BiometricModality::Fingerprint) => 1,
        Some(lifegraph_biometrics::BiometricModality::Face) => 2,
        Some(lifegraph_biometrics::BiometricModality::Voice) => 3,
        Some(lifegraph_biometrics::BiometricModality::Iris) => 4,
        Some(lifegraph_biometrics::BiometricModality::Palm) => 5,
        Some(lifegraph_biometrics::BiometricModality::Other(_)) => 255,
        None => 0,
    });
    out
}
...
pub fn decode_camera_capture(bytes: &[u8]) -> Result<CameraCapture, CapabilityError> {
    ...
    let face_bounds = if has_bounds {
        ...
        cursor += 4;
        Some(lifegraph_camera_biometrics::FaceBounds {
            x,
            y,
            width,
            height,
    ...
    let modality = match bytes[cursor + 3] {
        0 => None,
        1 => Some(lifegraph_biometrics::BiometricModality::Fingerprint),
        2 => Some(lifegraph_biometrics::BiometricModality::Face),
        3 => Some(lifegraph_biometrics::BiometricModality::Voice),
        4 => Some(lifegraph_biometrics::BiometricModality::Iris),
        5 => Some(lifegraph_biometrics::BiometricModality::Palm),
        _ => None,
    };
    Ok(CameraCapture {
        frame,
        quality,
        face_bounds,
        state: lifegraph_biometrics::BiometricState {
            modality,
    ...
    D: InputDevice,
{
    ...
    fn next_event(
        ...
        Ok(Some(CapabilitySessionEvent {
            ...
            sequence_no,
            event_kinds: vec![
                lifegraph_capabilities::CapabilityEventKind::Touch as i32,
                lifegraph_capabilities::CapabilityEventKind::Text as i32,
                lifegraph_capabilities::CapabilityEventKind::State as i32,
            ],
            payload_object: None,
    ...
    D: MicrophoneDevice,
{
    ...
    fn next_event(
        ...
        Ok(Some(CapabilitySessionEvent {
            ...
            session_id: session_id.to_vec(),
            sequence_no,
            event_kinds: vec![lifegraph_capabilities::CapabilityEventKind::Auditory as i32],
            payload_object: None,
    ...
    D: SpeakerDevice,
{
    ...
    fn invoke(
        ...
        let output_level = if invocation.operation
            == lifegraph_capabilities::CapabilityOperation::Control as i32
        {
            let target =
                request
        ...
        let playback =
            if invocation.operation == lifegraph_capabilities::CapabilityOperation::Render as i32 {
        ...
        Ok(RemoteInvocationResult {
            result: CapabilityResult {
                ...
                produced_event_kinds: vec![
                    lifegraph_capabilities::CapabilityEventKind::Auditory as i32,
                ],
                payload_object: None,
                error_reason: String::new(),
                produced_at: None,
    ...
    D: BluetoothScanner,
{
    ...
    fn next_event(
        ...
        Ok(Some(CapabilitySessionEvent {
            ...
            session_id: session_id.to_vec(),
            sequence_no,
            event_kinds: vec![lifegraph_capabilities::CapabilityEventKind::Radio as i32],
            payload_object: None,
    ...
    fn invoke(
        ...
        Ok(RemoteInvocationResult {
            result: CapabilityResult {
                ...
                result_access_class: invocation.requested_access_class,
                produced_event_kinds: vec![
                    lifegraph_capabilities::CapabilityEventKind::Radio as i32,
                ],
                payload_object: None,
                error_reason: String::new(),
                produced_at: None,
    ...
    D: CameraBiometricReader,
{
    ...
    fn next_event(
        ...
        Ok(Some(CapabilitySessionEvent {
            ...
            session_id: session_id.to_vec(),
            sequence_no,
            event_kinds: vec![lifegraph_capabilities::CapabilityEventKind::Visual as i32],
            payload_object: None,
...
mod tests {
    use super::*;
    use lifegraph_bluetooth::{default_bluetooth_descriptor, BluetoothScanResult};
    use lifegraph_camera_biometrics::{
    ...
    use lifegraph_input::{InputDeviceInfo, InputDeviceKind};
    use lifegraph_microphone::MicrophoneInfo;
    use lifegraph_proto::lifegraph::v0::capability::{CapabilityInvocation, CapabilityResult};
    use lifegraph_speaker::{AudioPlaybackRequest, SpeakerInfo, SpeakerOutputLevel};
    use lifegraph_wifi::{
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyInputDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
            capability_descriptor(
                "dummy-input",
                "event0",
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyMicrophoneDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
            capability_descriptor(
                "dummy-mic",
                "hw:0,0",
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummySpeakerDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
            capability_descriptor(
                "dummy-speaker",
                "hw:0,0",
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyBluetoothScannerDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyBluetoothConnectionDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
            default_bluetooth_descriptor("dummy-bt", "hci0")
        }
    }
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyWifiScannerDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
    ...
    impl lifegraph_capabilities::CapabilityProvider for DummyWifiControllerDevice {
        fn descriptor(&self) -> CapabilityDescriptor {
            default_wifi_descriptor("dummy-wifi", "wlan0")
        }
    }
    ...
    impl DummyCameraDevice {
        fn descriptor() -> CapabilityDescriptor {
            lifegraph_capabilities::capability_descriptor(
                "dummy-camera",
                "video0",
                lifegraph_capabilities::CapabilityRole::Input,
                &[lifegraph_capabilities::CapabilityModality::Visual],
                &[lifegraph_capabilities::CapabilityEventKind::Visual],
                &[lifegraph_capabilities::CapabilityOperation::Observe],
                Vec::new(),
            )
        }
    }
    ...
    impl CameraBiometricReader for DummyCameraDevice {
        ...
        fn begin_enrollment(
            &mut self,
            _request: &lifegraph_camera_biometrics::CameraEnrollRequest,
        ) -> Result<lifegraph_camera_biometrics::CameraEnrollmentSession, CameraBiometricError>
        {
        ...
        ) -> Result<lifegraph_camera_biometrics::CameraEnrollProgress, CameraBiometricError>
        {
            Err(CameraBiometricError::UnsupportedOperation("dummy"))
        }
        fn finish_enrollment(
            &mut self,
            _session_id: &str,
        ) -> Result<lifegraph_camera_biometrics::CameraTemplateRecord, CameraBiometricError>
        {
            Err(CameraBiometricError::UnsupportedOperation("dummy"))
        }
        fn verify_capture(
            &mut self,
            _request: &lifegraph_camera_biometrics::CameraVerifyRequest,
            _capture: &CameraCapture,
        ) -> Result<lifegraph_camera_biometrics::CameraVerification, CameraBiometricError> {
            Err(CameraBiometricError::UnsupportedOperation("dummy"))
        }
        fn list_templates(
            &self,
        ) -> Result<Vec<lifegraph_camera_biometrics::CameraTemplateRecord>, CameraBiometricError>
        {
            Ok(Vec::new())
        }
    ...
    impl PairedCameraBiometricReader for DummyPairedCameraDevice {
        ...
        fn evaluate_liveness(
            &mut self,
            _challenge: &lifegraph_camera_biometrics::CameraLivenessChallenge,
            _capture: &PairedCameraFrame,
        ) -> Result<lifegraph_camera_biometrics::CameraLivenessResult, CameraBiometricError>
        {
            Err(CameraBiometricError::UnsupportedOperation("dummy"))
        }
    }
    ...
    fn camera_capture_payload_roundtrip() {
        let capture = CameraCapture {
            ...
            face_bounds: Some(lifegraph_camera_biometrics::FaceBounds {
                x: 10,
                y: 20,
                width: 100,
                height: 120,
