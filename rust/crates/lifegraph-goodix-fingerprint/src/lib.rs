...
fn capture_quality_from_raw(value: u8) -> lifegraph_fingerprint::FingerprintCaptureQuality {
    match value {
        0..=24 => lifegraph_fingerprint::FingerprintCaptureQuality::Poor,
        25..=49 => lifegraph_fingerprint::FingerprintCaptureQuality::Fair,
        50..=79 => lifegraph_fingerprint::FingerprintCaptureQuality::Good,
        _ => lifegraph_fingerprint::FingerprintCaptureQuality::Excellent,
    }
}
...
impl FingerprintReader for GoodixFingerprintReader {
    ...
    fn capture(
        ...
        Ok(FingerprintCapture {
            bytes: Vec::new(),
            quality,
            state: lifegraph_fingerprint::default_fingerprint_biometric_state(false, true, true),
        })
    }
    ...
    fn verify_capture(
        ...
        Ok(FingerprintVerification {
            ...
            state: lifegraph_fingerprint::default_fingerprint_biometric_state(
                result.matched,
                true,
                true,
            ),
...
mod tests {
    ...
    fn capture_quality_from_raw_maps_expected_ranges() {
        assert_eq!(
            ...
            lifegraph_fingerprint::FingerprintCaptureQuality::Poor
        );
        assert_eq!(
            capture_quality_from_raw(25),
            lifegraph_fingerprint::FingerprintCaptureQuality::Fair
        );
        assert_eq!(
            capture_quality_from_raw(50),
            lifegraph_fingerprint::FingerprintCaptureQuality::Good
        );
        assert_eq!(
            capture_quality_from_raw(80),
            lifegraph_fingerprint::FingerprintCaptureQuality::Excellent
        );
    }
