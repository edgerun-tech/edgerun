  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_260px]">
      ...
      <Card className="overflow-hidden border-[var(--window-border)] bg-card/55 py-0 shadow-none">
        <div className="flex h-full min-h-[290px] flex-col p-4">
          <div className="mb-4 flex items-center gap-2 border-b border-[var(--window-border)] pb-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-muted-foreground">Current browser settings</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            {[
              ...
              ["Window blur", settings.windowBlur ? "On" : "Off"],
              ["Animations", settings.animations ? "On" : "Off"],
              ["Compact mode", settings.compactMode ? "On" : "Off"],
            ].map(([label, value]) => (
              <div key={label} className="flex items-center justify-between gap-4 rounded-md border border-[var(--window-border)] bg-background/35 px-3 py-2">
