...
writeFileSync(path.join(distRoot, 'sitemap.xml'), `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${paths.map((href) => `  <url><loc>${siteUrl}${href}</loc></url>`).join('\n')}\n</urlset>\n`, 'utf8')
...
const llmsBase = ['# Edgerun', '', '> Deterministic WASM compute with SOL settlement.', '', `Version: ${currentVersion}`, `Build: ${buildNumber}`, `Docs: ${siteUrl}/docs/${currentVersion}/`, `Releases: ${siteUrl}/releases/`].join('\n')
