/**
 * Xray WebGL shader programs and utilities.
 * Extracted from codeanalyzer gl.js - shaders for node point sprites and line edges.
 * Initial version: keep shaders identical, only organize/rename.
 */

// Node vertex shader - point sprites with zoom/pan/rotation
...
// Node fragment shader - circular point sprites with selection ring
...
// Edge vertex shader - lines with zoom/pan/rotation
...
// Edge fragment shader - simple color
...
/**
 * Language to color mapping (initial - from codeanalyzer)
 * @param {string} lang
