...
import { TbOutlineClock, TbOutlineCloudUpload } from "solid-icons/tb";
...
function ActivityFeed() {
  ...
  return <div class="h-full flex flex-col bg-[#1a1a1a] text-neutral-200">
      {
    /* Header */
  }
    ...
    class={`px-3 py-1.5 rounded-lg text-sm whitespace-nowrap transition-colors ${filter() === type.value ? "bg-neutral-700 text-white" : "text-neutral-400 hover:text-white hover:bg-neutral-800"}`}
  >
              {type.label}
            </button>}
        </For>
    ...
    fallback={<div class="flex flex-col items-center justify-center h-full text-neutral-500">
