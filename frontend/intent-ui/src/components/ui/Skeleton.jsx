...
function WindowSkeleton(props) {
  return <div class="h-full flex flex-col bg-[#1a1a1a]">
      ...
      <div class="flex-1 p-4 space-y-4">
        {props.showTabs && <div class="flex gap-2">
...
function EditorSkeleton() {
  return <div class="h-full flex flex-col bg-[#1e1e1e]">
      <div class="h-9 flex items-center gap-1 px-2 border-b border-neutral-700">
        {["src", "components", "utils"].map((tab) => <div class="flex items-center gap-2 px-3 h-full bg-[#2d2d2d] border-t-2 border-t-blue-500">
      ...
      <div class="flex-1 flex">
        <div class="w-48 border-r border-neutral-700 p-2 space-y-2">
          {Array.from({ length: 8 }).map(() => <div class="flex items-center gap-2">
        ...
        <div class="flex-1 p-4 space-y-1">
          {Array.from({ length: 15 }).map((_, i) => <div class="flex items-center gap-3">
...
function FileManagerSkeleton() {
  return <div class="h-full flex flex-col bg-[#1a1a1a]">
      ...
      <div class="flex-1 p-2 space-y-1">
        {Array.from({ length: 12 }).map(() => <div class="flex items-center gap-3 p-2 hover:bg-neutral-800 rounded">
...
function LoadingDots(props) {
  return <div class={`flex items-center gap-1 ${props.class || ""}`}>
