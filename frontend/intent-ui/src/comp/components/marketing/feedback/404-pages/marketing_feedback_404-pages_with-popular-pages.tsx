    ...
    <div class="bg-white dark:bg-gray-900">
      <main class="mx-auto w-full max-w-7xl px-6 pt-10 pb-16 sm:pb-24 lg:px-8">
        <img
          ...
          class="mx-auto h-10 w-auto sm:h-12 dark:hidden"
        />
        <img
          alt="Your Company"
          src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500"
          class="mx-auto h-10 w-auto hidden sm:h-12"
        />
        <div class="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
          ...
          <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl dark:text-white">
            ...
            {links.map((link, _linkIdx) => (
              <li class="relative flex gap-x-6 py-6">
                <div class="flex size-10 flex-none items-center justify-center rounded-lg shadow-xs outline-1 outline-gray-900/10 dark:bg-gray-800/50 dark:-outline-offset-1 dark:outline-white/10">
                  <link.icon aria-hidden="true" class="size-6 text-indigo-600 dark:text-indigo-400" />
                </div>
                <div class="flex-auto">
