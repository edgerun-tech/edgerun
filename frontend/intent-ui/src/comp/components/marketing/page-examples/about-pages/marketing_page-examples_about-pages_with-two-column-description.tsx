...
const values: Array<{ name: string; description: string; icon: any }> = [
  {
    name: 'Be world-class.',
      ...
      <main class="relative isolate">
        ...
        <div class="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <dl class="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
              {stats.map((stat, _statIdx) => (
                <div
                  class="flex flex-col-reverse gap-y-3 border-l border-gray-200 pl-6 dark:border-white/20"
                >
        ...
        <div class="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
          <img
            ...
            class="aspect-9/4 w-full object-cover outline-1 -outline-offset-1 outline-black/5 xl:rounded-3xl dark:outline-white/10"
          />
        </div>
        {/* Feature section */}
        ...
        <div class="relative isolate -z-10 mt-32 sm:mt-40">
          <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="mx-auto flex max-w-2xl flex-col gap-16 bg-white/75 px-6 py-16 shadow-lg ring-1 ring-gray-900/5 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20 dark:bg-white/3 dark:shadow-none dark:ring-white/10">
              ...
              <div class="w-full flex-auto">
                <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-950 sm:text-5xl dark:text-white">
                  Join our team
                </h2>
                <p class="mt-6 text-lg/8 text-pretty text-gray-600 dark:text-gray-400">
                ...
                <div class="mt-10 flex">
                  <a
                    href="#"
                    class="text-sm/6 font-semibold text-indigo-600 hover:text-indigo-300 dark:text-indigo-400 dark:hover:text-indigo-300"
                  >
          ...
          >
            <div
              ...
              class="aspect-1318/752 w-329.5 flex-none bg-linear-to-r from-[#9fd6fc] to-[#8680fd] opacity-50 dark:from-[#80caff] dark:to-[#4f46e5] dark:opacity-20"
            />
          </div>
        </div>
      </main>
