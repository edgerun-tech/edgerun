      ...
      <main class="isolate">
        ...
        <div class="relative isolate -z-10">
          ...
          >
            ...
            <rect fill="url(#1f932ae7-37de-4c0a-a8b0-a6e3b4d44b84)" width="100%" height="100%" stroke-width={0} />
          </svg>
          <div
            aria-hidden="true"
        ...
        <div class="relative isolate -z-10 mt-32 sm:mt-48">
          <div class="absolute inset-x-0 top-1/2 -z-10 flex -translate-y-1/2 justify-center overflow-hidden mask-[radial-gradient(50%_45%_at_50%_55%,white,transparent)]">
            <svg aria-hidden="true" class="h-160 w-7xl flex-none stroke-gray-200 dark:stroke-white/10">
              ...
              <rect fill="url(#e9033f3e-f665-41a6-84ef-756f6778e6fe)" width="100%" height="100%" stroke-width={0} />
            </svg>
          </div>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          ...
          <div class="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {blogPosts.map((post) => (
              ...
              >
                <img alt="" src={post.imageUrl} class="absolute inset-0 -z-10 size-full object-cover" />
