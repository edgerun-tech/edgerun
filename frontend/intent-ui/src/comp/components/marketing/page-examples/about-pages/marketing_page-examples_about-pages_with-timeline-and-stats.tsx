    ...
    <div class="bg-white dark:bg-gray-900">
      ...
      <main class="isolate">
        ...
        <div class="relative isolate -z-10 overflow-hidden bg-linear-to-b from-indigo-100/20 pt-14 dark:from-indigo-950/10">
          <div
            aria-hidden="true"
            class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl ring-1 shadow-indigo-600/10 ring-indigo-50 sm:-mr-80 lg:-mr-96 dark:bg-gray-800/30 dark:shadow-indigo-400/10 dark:ring-white/5"
          />
            ...
            {timeline.map((item) => (
              <div>
                ...
                >
                  ...
                  <div
                    aria-hidden="true"
                    class="absolute -ml-2 h-px w-screen -translate-x-full bg-gray-900/10 sm:-ml-4 lg:static lg:-mr-6 lg:ml-8 lg:w-auto lg:flex-auto lg:translate-x-0 dark:bg-white/15"
                  />
                </time>
          ...
          <div class="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end">
            ...
            <div class="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-gray-900 p-8 sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-sm lg:flex-auto lg:flex-col lg:items-start lg:gap-y-44 dark:bg-gray-700 dark:inset-ring dark:inset-ring-white/10">
              ...
              <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p class="mt-2 text-base/7 text-gray-400 dark:text-gray-300">
            ...
            <div class="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl bg-indigo-600 p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28 dark:inset-ring dark:inset-ring-white/10">
              ...
              <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p class="mt-2 text-base/7 text-indigo-200 dark:text-indigo-100">
