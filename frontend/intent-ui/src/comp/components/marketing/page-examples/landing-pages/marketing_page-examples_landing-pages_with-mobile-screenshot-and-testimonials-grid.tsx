...
const primaryFeatures: Array<{ name: string; description: string; icon: any }> = [
  {
    name: 'Push to deploy.',
...
const secondaryFeatures: Array<{ name: string; description: string; href: string; icon: any }> = [
  {
    name: 'Push to deploy',
    description:
    ...
    <div class="bg-white dark:bg-gray-900">
      ...
      <main>
            ...
            <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div class="flex">
                <div class="relative flex items-center gap-x-4 rounded-full bg-white px-4 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:bg-white/5 dark:text-gray-300 dark:ring-white/10 dark:hover:ring-white/20">
                  ...
                  <span aria-hidden="true" class="h-4 w-px bg-gray-900/10 dark:bg-white/10" />
                  <a href="#" class="flex items-center gap-x-1">
                    <span aria-hidden="true" class="absolute inset-0" />
                    See open positions
                    <ChevronRightIcon aria-hidden="true" class="-mr-2 size-5 text-gray-400" />
                  </a>
                </div>
              </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-12 opacity-40 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            ...
            <img
              ...
              width={158}
              height={48}
              class="col-span-2 max-h-12 w-full object-contain hidden lg:col-span-1"
            />
            <img
              alt="Reform"
            ...
            <img
              ...
              width={158}
              height={48}
              class="col-span-2 max-h-12 w-full object-contain hidden sm:col-start-2 lg:col-span-1"
            />
            <img
              alt="Statamic"
            ...
            <img
              ...
              width={158}
              height={48}
              class="col-span-2 col-start-2 max-h-12 w-full object-contain hidden sm:col-start-auto lg:col-span-1"
            />
          </div>
        </div>
        {/* Feature section */}
          ...
          <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24 dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-0 dark:after:inset-ring dark:after:inset-ring-white/10 dark:after:sm:rounded-3xl">
                  ...
                  {primaryFeatures.map((feature) => (
                    <div class="relative">
                      <dt class="ml-9 inline-block font-semibold text-white">
                        <feature.icon
                          aria-hidden="true"
                          class="absolute top-1 left-1 size-5 text-indigo-500 dark:text-indigo-400"
                        />
                        {feature.name}
                      </dt>{' '}
            ...
            >
              <div
                ...
                class="aspect-1155/678 w-288.75 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-25 dark:opacity-20"
              />
            </div>
          </div>
        </div>
              ...
              {secondaryFeatures.map((feature) => (
                <div class="flex flex-col">
                  <dt class="flex items-center gap-x-3 text-base/7 font-semibold text-gray-900 dark:text-white">
                    <feature.icon
                      aria-hidden="true"
                      class="size-5 flex-none text-indigo-600 dark:text-indigo-400"
                    />
                    {feature.name}
                  </dt>
          ...
          <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32 dark:bg-gray-800 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-0 dark:after:inset-ring dark:after:inset-ring-white/15 dark:after:sm:rounded-3xl">
            ...
            <form class="mx-auto mt-10 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autocomplete="email"
                class="min-w-0 flex-auto rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6 dark:outline-white/20"
              />
              <button
                type="submit"
                class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-xs hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white dark:shadow-none"
              >
                Notify me
              </button>
            </form>
        ...
        <div class="relative isolate mt-32 sm:mt-56 sm:pt-32">
          <svg
            aria-hidden="true"
            class="absolute inset-0 -z-10 hidden size-full mask-[radial-gradient(64rem_64rem_at_top,white,transparent)] stroke-gray-200 sm:block dark:stroke-white/10"
          >
            <defs>
              <pattern
                x="50%"
                ...
                <figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1 dark:bg-gray-800/75 dark:shadow-none dark:ring-white/10">
                  ...
                  <figcaption class="flex flex-wrap items-center gap-x-4 gap-y-4 border-t border-gray-900/10 px-6 py-4 sm:flex-nowrap dark:border-white/10">
                    ...
                    <img
                      ...
                      class="h-10 w-auto flex-none dark:hidden"
                    />
                    <img
                      alt=""
                      src={featuredTestimonial.author.logoUrl.replace('-gray-900', '-gray-100')}
                      class="h-10 w-auto flex-none hidden"
                    />
                  </figcaption>
                </figure>
                    ...
                    {columnGroup.map((column, columnIdx) => (
                      ...
                      >
                        {column.map((testimonial) => (
                          <figure
                            class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5 dark:bg-gray-800/75 dark:shadow-none dark:ring-white/10"
                          >
          ...
          <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between dark:border-white/10">
            ...
            <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <div class="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
                <button
                  type="submit"
                  class="flex w-full items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500"
                >
                  Subscribe
                </button>
              </div>
