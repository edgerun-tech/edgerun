      ...
      <main class="isolate">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="mt-16 flex justify-center">
            <p class="relative rounded-full bg-white/25 px-4 py-1.5 text-sm/6 text-gray-600 inset-ring inset-ring-gray-900/10 dark:bg-gray-800/25 dark:text-gray-400 dark:inset-ring-white/10">
              ...
              >
                <span aria-hidden="true" class="absolute inset-0" /> Read our case study{' '}
        ...
        <div class="py-24 sm:pt-48">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-gray-600 sm:text-xl/8 dark:text-gray-400">
                ...
                >
                  <div>
                    <div class="flex items-center justify-between gap-x-4">
                      ...
                      {tier.mostPopular ? (
                        <p class="rounded-full bg-indigo-600/10 px-2.5 py-1 text-xs/5 font-semibold text-indigo-600 dark:bg-indigo-400/10 dark:text-indigo-400">
                          Most popular
                        </p>
                      ) : null}
                    </div>
