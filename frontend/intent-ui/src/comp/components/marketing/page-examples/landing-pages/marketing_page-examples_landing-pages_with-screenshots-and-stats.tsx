...
const primaryFeatures: Array<{ name: string; description: string; href: string; icon: any }> = [
  {
...
const secondaryFeatures: Array<{ name: string; description: string; icon: any }> = [
  {
    name: 'Push to deploy.',
      ...
      <main>
        ...
        <div class="relative isolate overflow-hidden bg-white dark:bg-gray-900">
          ...
          >
            ...
            <rect fill="url(#983e3e4c-de6d-4c3f-8d64-b9761d1534cc)" width="100%" height="100%" stroke-width={0} />
          </svg>
          <div
            aria-hidden="true"
              ...
              <div class="mt-24 sm:mt-32 lg:mt-16">
                <a href="#" class="inline-flex space-x-6">
                  ...
                  <span class="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-600 dark:text-gray-300">
                    ...
                    <ChevronRightIcon aria-hidden="true" class="size-5 text-gray-400 dark:text-gray-500" />
                  </span>
                </a>
              </div>
            ...
            <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-32">
              <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                ...
                <img
                  ...
                  width={2432}
                  height={1442}
                  class="w-304 rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 hidden"
                />
              </div>
            </div>
          </div>
                ...
                <div class="flex flex-col">
                  <dt class="text-base/7 font-semibold text-gray-900 dark:text-white">
                    <div class="mb-6 flex size-10 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500">
                      <feature.icon aria-hidden="true" class="size-6 text-white" />
                    </div>
                    {feature.name}
                  </dt>
        ...
        <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          ...
          <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-gray-900 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4 dark:text-white">
            {stats.map((stat) => (
              <div
                class="flex flex-col gap-y-3 border-l border-gray-900/15 pl-6 dark:border-white/10"
              >
        ...
        <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          >
            ...
            <rect fill="url(#1d4240dd-898f-445f-932d-e2872fd12de3)" width="100%" height="100%" stroke-width={0} />
          </svg>
          <div
            aria-hidden="true"
