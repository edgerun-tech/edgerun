          ...
          <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/50 p-2 ring-1 ring-gray-200 dark:bg-white/5 dark:ring-white/10">
                <CalendarDaysIcon aria-hidden="true" class="size-6 text-gray-600 dark:text-white" />
              </div>
            ...
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/50 p-2 ring-1 ring-gray-200 dark:bg-white/5 dark:ring-white/10">
                <HandRaisedIcon aria-hidden="true" class="size-6 text-gray-600 dark:text-white" />
              </div>
