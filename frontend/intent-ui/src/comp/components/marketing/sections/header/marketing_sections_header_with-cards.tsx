  ...
  return (
    <div class="relative isolate overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
      ...
      <img
        ...
        class="absolute inset-0 -z-10 size-full object-cover object-right hidden md:object-center"
      />
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8">
          {cards.map((card) => (
            ...
            >
              <card.icon aria-hidden="true" class="h-7 w-5 flex-none text-indigo-600 dark:text-indigo-400" />
