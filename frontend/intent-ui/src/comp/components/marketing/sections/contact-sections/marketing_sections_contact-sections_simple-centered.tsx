      ...
      <div class="mx-auto mt-20 max-w-lg space-y-16">
        <div class="flex gap-x-6">
          <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500">
            <ChatBubbleLeftRightIcon aria-hidden="true" class="size-6 text-white" />
          </div>
          <div>
        ...
        <div class="flex gap-x-6">
          <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500">
            <BugAntIcon aria-hidden="true" class="size-6 text-white" />
          </div>
          <div>
        ...
        <div class="flex gap-x-6">
          <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-indigo-600 dark:bg-indigo-500">
            <ComputerDesktopIcon aria-hidden="true" class="size-6 text-white" />
          </div>
          <div>
