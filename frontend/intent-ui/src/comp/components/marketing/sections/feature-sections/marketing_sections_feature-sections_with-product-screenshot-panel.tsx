        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
          ...
          <div class="sm:px-6 lg:px-0">
            <div class="relative isolate overflow-hidden bg-indigo-500 px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pt-16 sm:pr-0 sm:pl-16 lg:mx-0 lg:max-w-none">
              <div
                aria-hidden="true"
                class="absolute -inset-y-px -left-3 -z-10 w-full origin-bottom-left skew-x-[-30deg] bg-indigo-100 opacity-20 ring-1 ring-white ring-inset"
              />
              <div class="mx-auto max-w-2xl sm:mx-0 sm:max-w-none">
                <img
                  ...
                  width={2432}
                  height={1442}
                  class="-mb-12 w-228 max-w-none rounded-tl-xl bg-gray-800 ring-1 ring-white/10 dark:hidden"
                />
                <img
                  alt="Product screenshot"
                  ...
                  width={2432}
                  height={1442}
                  class="-mb-12 w-228 max-w-none rounded-tl-xl bg-gray-950 ring-1 ring-white/10 hidden"
                />
              </div>
              <div
                aria-hidden="true"
                class="pointer-events-none absolute inset-0 ring-1 ring-black/10 ring-inset sm:rounded-3xl dark:ring-white/10"
              />
            </div>
          </div>
        </div>
