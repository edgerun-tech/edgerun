    ...
    <div class="relative isolate overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
      ...
      >
        <div
          ...
          class="aspect-801/1036 w-200.25 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 dark:opacity-20"
        />
      </div>
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
          <div class="relative lg:order-last lg:col-span-5">
            <svg
              aria-hidden="true"
              class="absolute -top-160 left-1 -z-10 h-256 w-702 -translate-x-1/2 mask-[radial-gradient(64rem_64rem_at_111.5rem_0%,white,transparent)] stroke-gray-900/10 dark:stroke-white/10"
            >
              <defs>
                <pattern
              ...
              <rect fill="url(#e87443c8-56e4-4c20-9111-55b82fa704e3)" width="100%" height="100%" stroke-width={0} />
            </svg>
            <figure class="border-l border-indigo-600 pl-8 dark:border-indigo-400">
              ...
              <figcaption class="mt-8 flex gap-x-4">
                <img
                  ...
                  class="mt-1 size-10 flex-none rounded-full bg-gray-50 dark:bg-gray-800"
                />
                <div class="text-sm/6">
          ...
          <div class="max-w-xl text-base/7 text-gray-600 lg:col-span-7 dark:text-gray-400">
            ...
            <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600 dark:text-gray-400">
              <li class="flex gap-x-3">
                ...
                />
                <span>
                  <strong class="font-semibold text-gray-900 dark:text-white">Push to deploy.</strong> Lorem ipsum,
              ...
              <li class="flex gap-x-3">
                ...
                />
                <span>
                  <strong class="font-semibold text-gray-900 dark:text-white">SSL certificates.</strong> Anim aute
                  id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.
                </span>
              </li>
              <li class="flex gap-x-3">
                <ServerIcon aria-hidden="true" class="mt-1 size-5 flex-none text-indigo-600 dark:text-indigo-400" />
                <span>
                  <strong class="font-semibold text-gray-900 dark:text-white">Database backups.</strong> Ac
