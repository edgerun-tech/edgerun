export interface WithBrandIconProps {
  class?: string;
}
export function WithBrandIcon(props: WithBrandIconProps): JSX.Element {
  return (
  ...
  <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    <div>
      ...
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-12 shadow-sm sm:px-6 sm:pt-6 dark:bg-gray-800/75 dark:inset-ring dark:inset-ring-white/10">
          <dt>
            ...
            <p class="ml-16 truncate text-sm font-medium text-gray-500 dark:text-gray-400">Total Subscribers</p>
          </dt>
          <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">71,897</p>
            <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600 dark:text-green-400">
              <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden={true} class="size-5 shrink-0 self-center text-green-500 dark:text-green-400">
            ...
            <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6 dark:bg-gray-700/20">
              <div class="text-sm">
                <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">View all<span class="sr-only"> Total Subscribers stats</span></a>
              </div>
            </div>
          </dd>
        </div>
        <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-12 shadow-sm sm:px-6 sm:pt-6 dark:bg-gray-800/75 dark:inset-ring dark:inset-ring-white/10">
          <dt>
            ...
            <p class="ml-16 truncate text-sm font-medium text-gray-500 dark:text-gray-400">Avg. Open Rate</p>
          </dt>
          <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">58.16%</p>
            <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600 dark:text-green-400">
              <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden={true} class="size-5 shrink-0 self-center text-green-500 dark:text-green-400">
                <path d="M10 17a.75.75 0 0 1-.75-.75V5.612L5.29 9.77a.75.75 0 0 1-1.08-1.04l5.25-5.5a.75.75 0 0 1 1.08 0l5.25 5.5a.75.75 0 1 1-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0 1 10 17Z" clip-rule="evenodd" fill-rule="evenodd" />
              </svg>
            ...
            <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6 dark:bg-gray-700/20">
              <div class="text-sm">
                <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">View all<span class="sr-only"> Avg. Open Rate stats</span></a>
              </div>
            </div>
          </dd>
        </div>
        <div class="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-12 shadow-sm sm:px-6 sm:pt-6 dark:bg-gray-800/75 dark:inset-ring dark:inset-ring-white/10">
          <dt>
            ...
            <p class="ml-16 truncate text-sm font-medium text-gray-500 dark:text-gray-400">Avg. Click Rate</p>
          </dt>
          <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">24.57%</p>
            <p class="ml-2 flex items-baseline text-sm font-semibold text-red-600 dark:text-red-400">
              <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden={true} class="size-5 shrink-0 self-center text-red-500 dark:text-red-400">
            ...
            <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6 dark:bg-gray-700/20">
              <div class="text-sm">
                <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">View all<span class="sr-only"> Avg. Click Rate stats</span></a>
              </div>
            </div>
          </dd>
        </div>
