export interface WithMetaAndActionsProps {
  class?: string;
}
export function WithMetaAndActions(props: WithMetaAndActionsProps): JSX.Element {
  return (
    <div class={props.class || ""}>
<div style="min-height: 384px" class="bg-white p-8 dark:bg-gray-900 dark:scheme-dark">
