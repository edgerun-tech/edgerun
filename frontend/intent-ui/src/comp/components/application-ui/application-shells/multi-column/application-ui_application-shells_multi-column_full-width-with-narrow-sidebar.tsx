export interface FullWidthWithNarrowSidebarProps {
  class?: string;
}
export function FullWidthWithNarrowSidebar(props: FullWidthWithNarrowSidebarProps): JSX.Element {
  return (
...
<dialog id="sidebar" class="backdrop:bg-transparent lg:hidden">
      ...
      <div tabindex="0" class="fixed inset-0 flex focus:outline-none">
        <div class="group/dialog-panel relative mr-16 flex w-full max-w-xs flex-1 transform transition duration-300 ease-in-out data-closed:-translate-x-full">
          ...
          <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-2 ring-1 ring-white/10 focus:outline-none">
