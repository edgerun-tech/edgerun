export interface FullWidthSecondaryColumnOnRightProps {
  class?: string;
}
export function FullWidthSecondaryColumnOnRight(props: FullWidthSecondaryColumnOnRightProps): JSX.Element {
  return (
...
<dialog id="sidebar" class="backdrop:bg-transparent lg:hidden">
      ...
      <div tabindex="0" class="fixed inset-0 flex focus:outline-none">
        <div class="group/dialog-panel relative mr-16 flex w-full max-w-xs flex-1 transform transition duration-300 ease-in-out data-closed:-translate-x-full">
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 focus:outline-none dark:bg-gray-900 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:border-r dark:before:border-white/10 dark:before:bg-black/10">
            <div class="relative flex h-16 shrink-0 items-center">
              ...
              <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=400" alt="Your Company" class="h-8 w-auto hidden" />
            </div>
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 dark:border-white/10 dark:bg-gray-900 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10">
      <div class="relative flex h-16 shrink-0 items-center">
        <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company" class="h-8 w-auto dark:hidden" />
        <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" class="h-8 w-auto hidden" />
      </div>
      <nav class="relative flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
          <li>
...
<a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-gray-700 hover:bg-gray-50 hover:text-indigo-600 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
    ...
    <div class="xl:pr-96">
      <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-6">
        <x-placeholder message="Main area">
          <div class="relative h-[672px] overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
            <svg fill="none" class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-white/10">
              <defs>
                <pattern id="pattern-1526ac66-f54a-4681-8fb8-0859d412f251" width="10" height="10" x="0" y="0" patternUnits="userSpaceOnUse">
                  <path d="M-3 13 15-5M-5 5l18-18M-1 21 17 3" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#pattern-1526ac66-f54a-4681-8fb8-0859d412f251)" stroke="none" />
            </svg>
          </div>
        </x-placeholder>
      </div>
  ...
  <aside class="fixed inset-y-0 right-0 hidden w-96 overflow-y-auto border-l border-gray-200 px-4 py-6 sm:px-6 lg:px-8 xl:block dark:border-white/10">
    <x-placeholder message="Secondary column (hidden on smaller screens)">
      <div class="relative h-[672px] overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
        <svg fill="none" class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-white/10">
          <defs>
            <pattern id="pattern-1526ac66-f54a-4681-8fb8-0859d412f251" width="10" height="10" x="0" y="0" patternUnits="userSpaceOnUse">
