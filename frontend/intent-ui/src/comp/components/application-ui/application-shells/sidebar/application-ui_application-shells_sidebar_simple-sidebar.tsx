...
export function SimpleSidebar(props: SimpleSidebarProps): JSX.Element {
  return (
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 focus:outline-none dark:bg-gray-900 dark:ring dark:ring-white/10 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10">
