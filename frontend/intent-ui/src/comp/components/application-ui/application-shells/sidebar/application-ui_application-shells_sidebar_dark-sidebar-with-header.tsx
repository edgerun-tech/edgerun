export interface DarkSidebarWithHeaderProps {
  class?: string;
}
export function DarkSidebarWithHeader(props: DarkSidebarWithHeaderProps): JSX.Element {
  return (
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10 focus:outline-none dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10">
