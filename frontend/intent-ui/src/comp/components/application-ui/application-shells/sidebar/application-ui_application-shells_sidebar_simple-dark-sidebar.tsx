export interface SimpleDarkSidebarProps {
  class?: string;
}
export function SimpleDarkSidebar(props: SimpleDarkSidebarProps): JSX.Element {
  return (
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-2 ring-1 ring-white/10 focus:outline-none dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10">
            <div class="relative flex h-16 shrink-0 items-center">
              ...
              <img src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" class="relative h-8 w-auto hidden" />
            </div>
...
<a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-gray-400 hover:bg-white/5 hover:text-white">
  ...
  <main class="py-10 lg:pl-72">
    <div class="px-4 sm:px-6 lg:px-8">
      <x-placeholder>
        <div class="relative h-[640px] overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
