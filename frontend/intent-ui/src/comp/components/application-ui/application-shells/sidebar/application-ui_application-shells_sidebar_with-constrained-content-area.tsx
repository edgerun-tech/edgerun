export interface WithConstrainedContentAreaProps {
  class?: string;
}
export function WithConstrainedContentArea(props: WithConstrainedContentAreaProps): JSX.Element {
  return (
...
<div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 focus:outline-none dark:bg-gray-900 dark:ring dark:ring-white/10 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10">
...
<el-dropdown class="relative">
    ...
    <main class="py-10">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <x-placeholder>
          <div class="relative h-[576px] overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
