export interface WithLighterPageHeaderProps {
  class?: string;
}
export function WithLighterPageHeader(props: WithLighterPageHeaderProps): JSX.Element {
  return (
      ...
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <x-placeholder>
          <div class="relative h-96 overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
            <svg fill="none" class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-gray-100/10">
              <defs>
                <pattern id="pattern-d09edaee-fc6a-4f25-aca5-bf9f5f77e14a" width="10" height="10" x="0" y="0" patternUnits="userSpaceOnUse">
                  <path d="M-3 13 15-5M-5 5l18-18M-1 21 17 3" />
                </pattern>
              </defs>
              <rect width="100%" height="100%" fill="url(#pattern-d09edaee-fc6a-4f25-aca5-bf9f5f77e14a)" stroke="none" />
            </svg>
          </div>
        </x-placeholder>
      </div>
