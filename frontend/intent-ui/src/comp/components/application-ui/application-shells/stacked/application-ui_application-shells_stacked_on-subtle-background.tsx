export interface OnSubtleBackgroundProps {
  class?: string;
}
export function OnSubtleBackground(props: OnSubtleBackgroundProps): JSX.Element {
  return (
...
<el-dropdown class="relative ml-3">
              <button type="button" class="relative flex rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:focus-visible:outline-indigo-500">
                <span class="absolute -inset-1.5"></span>
          ...
          <x-placeholder>
            <div class="relative h-96 overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75 dark:border-white/20">
              <svg fill="none" class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-white/10">
                <defs>
                  <pattern id="pattern-003a54e1-93b5-4534-9ccb-0ed8812b8270" width="10" height="10" x="0" y="0" patternUnits="userSpaceOnUse">
                    <path d="M-3 13 15-5M-5 5l18-18M-1 21 17 3" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#pattern-003a54e1-93b5-4534-9ccb-0ed8812b8270)" stroke="none" />
              </svg>
            </div>
          </x-placeholder>
        </div>
