export interface WithOverlapProps {
  class?: string;
}
export function WithOverlap(props: WithOverlapProps): JSX.Element {
  return (
    ...
    <main class="relative -mt-32">
      <div class="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        <div class="rounded-lg bg-white px-5 py-6 shadow-sm sm:px-6 dark:bg-gray-800 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
          <x-placeholder>
            <div class="relative h-96 overflow-hidden rounded-sm border border-dashed border-gray-400 opacity-75 dark:border-white/20">
              <svg fill="none" class="absolute inset-0 size-full stroke-gray-900/10 dark:stroke-white/10">
                <defs>
                  <pattern id="pattern-bb904d76-8ce0-4b79-8986-92c472e1c066" width="10" height="10" x="0" y="0" patternUnits="userSpaceOnUse">
                    <path d="M-3 13 15-5M-5 5l18-18M-1 21 17 3" />
                  </pattern>
                </defs>
                <rect width="100%" height="100%" fill="url(#pattern-bb904d76-8ce0-4b79-8986-92c472e1c066)" stroke="none" />
              </svg>
            </div>
          </x-placeholder>
        </div>
