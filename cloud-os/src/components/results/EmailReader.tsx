/**
 * Email Reader
 * Gmail conversation view with threading
 */
...
import {
  TbOutlineMail, TbOutlineStar,
  TbOutlineMessage, TbOutlineShare, TbOutlineTrash, TbOutlineArchive
} from 'solid-icons/tb';
...
function parseEmailData(data: any): EmailMessage[] {
...
export function EmailReader(props: EmailReaderProps) {
          ...
          <button
            ...
            class={cn(
              ...
              starredOnly()
                ...
                : 'text-neutral-400 hover:text-yellow-400 hover:bg-neutral-700'
            )}
                ...
                <div class="border-t border-neutral-700 pt-4 mb-4">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <For each={selectedEmail()!.attachments}>
                      {(att) => (
                        <div class="flex items-center gap-2 px-3 py-2 bg-neutral-800 rounded-lg text-sm">
