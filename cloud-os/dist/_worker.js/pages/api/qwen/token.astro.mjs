...
const QWEN_CLIENT_ID = "";
const QWEN_CLIENT_SECRET = "";
const QWEN_TOKEN_URI = "https://portal.qwen.ai/oauth/token";
const QWEN_REDIRECT_URI = "http://localhost:4321/api/qwen/callback";
