...
import { an as REDIRECT_STATUS_CODES, A as AstroError, ao as ActionsReturnedInvalidDataError, ap as escape, D as DEFAULT_404_COMPONENT } from './astro/server_B5lkohcy.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, LD: process.env.LD, AR: process.env.AR, CC: process.env.CC })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, LD: process.env.LD, AR: process.env.AR, CC: process.env.CC })?.PROD) {
