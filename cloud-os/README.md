...
CloudOS is an AI-native, cloud-native operating system that treats the browser as the primary runtime and devices as capability providers.
...
- CloudOS schedules and routes eligible jobs to participating devices under policy constraints.

## What CloudOS Is Building Toward

- A unified environment where:
  - AI orchestrates work,
  - devices provide capabilities,
  - cloud providers provide transport and scale,
  - users keep cryptographic control over identity and data.

This repository contains the CloudOS frontend/control-surface foundation and integration plumbing evolving toward that model.
