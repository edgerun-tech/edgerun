...
async fn run_server() -> Result<(), edgerun_dns::std::io::Error> {
    ...
    zone.add_a(
        "@",
        edgerun_dns::std::net::Ipv4Addr::new(172, 245, 67, 49),
        3600,
    );
    zone.add_a(
        "ns1",
    ...
    zone.add_txt(
        "_dmarc",
        "v=DMARC1; p=quarantine; rua=mailto:dmarc-reports@edgerun.tech",
        3600,
    );
    ...
    zone.add_txt(
        "default._bimi",
        "v=BIMI1; l=https://mail.edgerun.tech/bimi/logo.svg",
        3600,
    );
