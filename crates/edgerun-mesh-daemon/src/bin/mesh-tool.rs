//! CLI tool for managing the edgerun mesh daemon.
//!
//! Usage:
...
use edgerun_mesh_daemon::{MeshDaemon, MeshDaemonConfig};
...
fn cmd_status() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Show interfaces
    let interfaces = edgerun_linux_netif::discover_network_interfaces()
