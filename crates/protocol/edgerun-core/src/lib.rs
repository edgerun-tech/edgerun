...
//! Legacy protocol records and validators.
//!
//! The workspace is converging authority semantics on `edgerun-work`. This
//! crate remains for existing native records, command validation, object refs,
//! and migration support. New cross-node authority should not be added here.

extern crate alloc;
extern crate edgerun_wire as rkyv;
