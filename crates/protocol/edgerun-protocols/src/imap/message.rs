    ...
    pub fn parse(
        ...
        match name.to_uppercase().as_str() {
            ...
            "STATUS" => {
                ...
                let items = super::parser::parse_paren_list(&args[1])
            ...
            "STORE" => {
                ...
                let flags = super::parser::parse_paren_list(&args[2])
            ...
            "APPEND" => {
                ...
                if i < args.len() && args[i].starts_with('(') {
                    flags = Some(super::parser::parse_paren_list(&args[i])?);
                    i += 1;
                }
                if i < args.len() && !args[i].starts_with('{') {
            ...
            "UID" => {
                ...
                let inner = match sub_cmd.as_str() {
                    ...
                    "STORE" => {
                        ...
                        let flags = super::parser::parse_paren_list(&sub_args[2])
            ...
            "SETQUOTA" => {
                ...
                let limits = super::parser::parse_paren_list(&args[1])
                    .unwrap_or_default()
                    .into_iter()
                    .filter_map(|s| {
            ...
            "SORT" => {
                ...
                let sort_criteria = super::parser::parse_paren_list(&args[0])
...
fn parse_fetch_attributes(args: &[String]) -> io::Result<Vec<FetchAttr>> {
    ...
    if args[0].starts_with('(') {
        ...
        let tokens = super::parser::parse_paren_list(&args[0])?;
        for token in &tokens {
