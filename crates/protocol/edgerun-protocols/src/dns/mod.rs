...
#[cfg(feature = "dnssec")]
pub use dnssec::{
    DnssecResult, compute_key_tag, find_nsec3_covering, generate_dnskey_ecdsap256,
    generate_dnskey_ed25519, nsec3_base32hex, nsec3_hash_owner, nsec3_type_bitmap,
    sign_rrset_ecdsap256, sign_rrsig_ed25519, sign_zone_ecdsap256, sign_zone_ed25519,
    synthesize_nsec3_chain, validate_response, verify_chain_of_trust, verify_rrsig,
};
pub use doh::{
    DOH_DNS_MESSAGE_CONTENT_TYPE, DOH_TEXT_CONTENT_TYPE, DohRequestError, decode_doh_get_query,
    decode_doh_post_query, doh_error_http_response, doh_formerr_http_response,
};
pub use limits::{
...
pub use query::{
    MAX_UDP_RESPONSE, ParseError, handle_query_without_forwarding, resolve, udp_response_wire,
};
pub use record::{DnsRecordData, DnsRecordType};
pub use resolv_conf::{Nameserver, ResolvConf};
pub use root_hints::{RootHint, default_root_hints};
pub use tcp_frame::{
...
pub use zone_file::{ZoneFileError, parse_zone_file};
