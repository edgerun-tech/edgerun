...
pub mod manager_request {
    ...
    pub const CAPTURE_OUTPUT_SIG: &[ArgType] = &[
        ArgType::NewId,
        ArgType::Uint,
        ArgType::Uint,
        ArgType::Object,
    ...
    pub const CAPTURE_OUTPUT_REGION_SIG: &[ArgType] = &[
        ArgType::NewId,
        ArgType::Uint,
        ArgType::Uint,
        ArgType::Object,
...
pub fn frame_buffer_event(
    ...
    push_u32_le(&mut args, width);
    push_u32_le(&mut args, height);
    push_u32_le(&mut args, stride);
    Message {
        sender_id: frame_id,
...
pub fn frame_damage_event(frame_id: u32, x: u32, y: u32, width: u32, height: u32) -> Message {
    let mut args = Vec::new();
    push_u32_le(&mut args, x);
    push_u32_le(&mut args, y);
    push_u32_le(&mut args, width);
    push_u32_le(&mut args, height);
    Message {
        sender_id: frame_id,
