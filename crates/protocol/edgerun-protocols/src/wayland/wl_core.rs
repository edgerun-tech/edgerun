...
pub fn global_event(name: u32, interface: &str, version: u32) -> Message {
    ...
    push_u32_le(&mut args, name);
    crate::wayland::encode::encode_string(&mut args, interface);
    push_u32_le(&mut args, version);
    Message {
        sender_id: 0,
        opcode: GLOBAL,
