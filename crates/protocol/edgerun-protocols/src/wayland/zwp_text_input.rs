...
use crate::wayland::encode::encode_string;
...
pub mod text_input_request {
    ...
    pub const SET_CURSOR_RECTANGLE_SIG: &[ArgType] =
...
pub fn enter_event(text_input_id: u32, surface_id: u32) -> Message {
...
/// Build a leave event.
pub fn leave_event(text_input_id: u32, surface_id: u32) -> Message {
...
pub fn preedit_string_event(text_input_id: u32, serial: u32, text: &str, commit: &str) -> Message {
...
pub fn commit_string_event(text_input_id: u32, serial: u32, text: &str) -> Message {
...
pub fn cursor_position_event(text_input_id: u32, index: u32, anchor: u32) -> Message {
    use text_input_event::CURSOR_POSITION;
    let mut args = Vec::new();
    push_u32_le(&mut args, index);
...
pub fn delete_surrounding_text_event(text_input_id: u32, index: u32, length: u32) -> Message {
    use text_input_event::DELETE_SURROUNDING_TEXT;
    let mut args = Vec::new();
    push_u32_le(&mut args, index);
    push_u32_le(&mut args, length);
    Message {
        sender_id: text_input_id,
