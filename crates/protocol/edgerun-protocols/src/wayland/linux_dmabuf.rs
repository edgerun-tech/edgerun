...
pub mod dmabuf_request {
    ...
    pub const CREATE_PARAMS_SIG: &[ArgType] =
        &[ArgType::NewId, ArgType::Int, ArgType::Int, ArgType::Uint];
    ...
    pub const CREATE_IMMED_SIG: &[ArgType] = &[
        ArgType::NewId,
        ArgType::Fd,
        ArgType::Int,
        ArgType::Int,
...
pub fn dmabuf_modifier_event(
    ...
    push_u32_le(&mut args, modifier_hi);
    push_u32_le(&mut args, modifier_lo);
    Message {
        sender_id: dmabuf_id,
        opcode: MODIFIER,
