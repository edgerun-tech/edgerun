...
pub fn encode(msg: &Message) -> Vec<u8> {
    ...
    // Header
    push_u32_le(&mut out, msg.sender_id);
    push_u16_le(&mut out, msg.opcode);
    push_u16_le(&mut out, msg.size);
...
pub fn message_uint2(sender_id: u32, opcode: u16, a: u32, b: u32) -> Message {
    ...
    push_u32_le(&mut args, a);
    push_u32_le(&mut args, b);
    Message {
        sender_id,
        opcode,
        size: 16,
...
mod tests {
    use super::*;
    use crate::wayland::decode::ArgCursor;
    ...
    fn test_encode_uint() {
        ...
        assert_eq!(read_u32_le(&msg.args, 0), 0x12345678);
    }
    ...
    fn test_encode_uint2() {
        ...
        assert_eq!(read_u32_le(&msg.args, 0), 0xAABBCCDD);
        assert_eq!(read_u32_le(&msg.args, 4), 0x11223344);
    }
