...
pub mod xdg_surface_request {
    ...
    pub const SET_WINDOW_GEOMETRY_SIG: &[ArgType] =
...
pub mod xdg_toplevel_request {
    ...
    pub const SHOW_WINDOW_MENU_SIG: &[ArgType] =
        &[ArgType::Object, ArgType::Uint, ArgType::Int, ArgType::Int];
...
pub fn xdg_toplevel_configure_event(
    ...
    push_i32_le(&mut args, width);
    push_i32_le(&mut args, height);
    crate::wayland::encode::encode_array(&mut args, states);
    Message {
        sender_id: toplevel_id,
...
pub fn xdg_toplevel_wm_capabilities_event(toplevel_id: u32, capabilities: &[u32]) -> Message {
    ...
    let mut bytes = Vec::with_capacity(capabilities.len() * 4);
    for &capability in capabilities {
        push_u32_le(&mut bytes, capability);
    }
    crate::wayland::encode::encode_array(&mut args, &bytes);
    Message {
        sender_id: toplevel_id,
...
pub mod xdg_positioner_request {
    ...
    pub const SET_ANCHOR_RECT_SIG: &[ArgType] =
        &[ArgType::Int, ArgType::Int, ArgType::Int, ArgType::Int];
