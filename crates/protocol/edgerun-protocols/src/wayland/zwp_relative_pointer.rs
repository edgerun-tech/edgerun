...
pub mod relative_pointer_manager_request {
    ...
    pub const GET_RELATIVE_POINTER_SIG: &[ArgType] = &[ArgType::Object, ArgType::NewId];
...
pub fn relative_motion_event(
    ...
    push_u32_le(&mut args, utime_hi);
    push_u32_le(&mut args, utime_lo);
    push_u32_le(&mut args, dx);
    push_u32_le(&mut args, dy);
    push_u32_le(&mut args, dx_unacc);
    push_u32_le(&mut args, dy_unacc);
    Message {
