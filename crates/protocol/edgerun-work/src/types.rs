...
impl NodeRole {
    ...
    pub const VERIFIER: Self = Self(NODE_ROLE_VERIFIER);
    ...
    pub fn from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            | NODE_ROLE_MESSAGE | NODE_ROLE_CAPABILITY | NODE_ROLE_NOTARY | NODE_ROLE_VERIFIER => {
                Some(Self(value))
            }
            _ => None,
        }
...
impl WorkType {
    ...
    pub const VERIFY_CLAIM: Self = Self(WORK_TYPE_VERIFY_CLAIM);
    ...
    pub fn from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            | WORK_TYPE_VERIFY_CLAIM => Some(Self(value)),
            _ => None,
        }
    }
...
impl Department {
    ...
    pub const VERIFICATION: Self = Self(DEPARTMENT_VERIFICATION);
    ...
    pub fn from_u16(value: u16) -> Option<Self> {
        match value {
            ...
            | DEPARTMENT_NOTARY
            | DEPARTMENT_VERIFICATION => Some(Self(value)),
            _ => None,
        }
    }
...
pub fn department_for_work_type_typed(work_type: WorkType) -> Option<Department> {
    match work_type.as_u16() {
        ...
        WORK_TYPE_VERIFY_CLAIM => Some(Department::VERIFICATION),
        _ => None,
    }
}
...
pub fn role_for_department_typed(department: Department) -> Option<NodeRole> {
    match department.as_u16() {
        ...
        DEPARTMENT_VERIFICATION => Some(NodeRole::VERIFIER),
        _ => None,
    }
}
