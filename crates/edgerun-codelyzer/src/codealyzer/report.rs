...
pub fn generate_report(
    ...
    if !cargo_toml_path.exists() {
        return Err(crate::codealyzer::errors::AnalyzerError::CrateNotFound(crate_name.into()));
    }
...
pub fn save_report(report: &CrateReport, output_dir: &Path) -> Result<(), crate::codealyzer::errors::AnalyzerError> {
