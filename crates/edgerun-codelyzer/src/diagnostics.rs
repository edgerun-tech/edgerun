...
use edgerun_json::{self, ToJson, JsonValue, Map};
...
impl ToJson for GraphEdge {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("source", &self.source);
        m.push_field("target", &self.target);
        JsonValue::Object(m)
    }
}
...
impl ToJson for GraphData {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("nodes", &self.nodes);
        m.push_field("edges", &self.edges);
        JsonValue::Object(m)
    }
}
...
impl ToJson for Diagnostic {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("file", &self.file);
        m.push_field("line", &self.line);
        m.push_field("column", &self.column);
        m.push_field("severity", &self.severity);
        m.push_field("message", &self.message);
        m.push_field("source", &self.source);
        JsonValue::Object(m)
    }
}
...
impl ToJson for TestResult {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("name", &self.name);
        m.push_field("passed", &self.passed);
        m.push_field("file", &self.file);
        m.push_field("message", &self.message);
        m.push_field("duration_ms", &self.duration_ms);
        JsonValue::Object(m)
    }
}
...
impl ToJson for CoverageInfo {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("file", &self.file);
        m.push_field("lines_total", &self.lines_total);
        m.push_field("lines_covered", &self.lines_covered);
        m.push_field("coverage_pct", &self.coverage_pct);
        JsonValue::Object(m)
    }
}
...
impl ToJson for DiagnosticsReport {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("linters_available", &self.linters_available);
        m.push_field("diagnostics", &self.diagnostics);
        m.push_field("tests", &self.tests);
        m.push_field("coverage", &self.coverage);
        m.push_field("formatting_issues", &self.formatting_issues);
        m.push_field("missing_references", &self.missing_references);
        m.push_field("scan_timestamp", &self.scan_timestamp);
        JsonValue::Object(m)
    }
}
...
impl ToJson for MissingRef {
    fn to_json(&self) -> JsonValue {
        let mut m = Map::new();
        m.push_field("name", &self.name);
        m.push_field("referenced_by", &self.referenced_by);
