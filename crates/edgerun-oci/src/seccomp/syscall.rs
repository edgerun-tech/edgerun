...
type SyscallEntry = (&'static str, u32);
fn lookup_syscall(table: &[SyscallEntry], name: &str) -> Option<u32> {
    table
        .iter()
...
pub fn syscall_nr(name: &str) -> Option<u32> {
    ...
    return lookup_syscall(X86_64_SYSCALLS, name);

    #[cfg(target_arch = "aarch64")]
    return lookup_syscall(AARCH64_SYSCALLS, name);
