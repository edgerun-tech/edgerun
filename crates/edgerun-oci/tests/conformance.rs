...
mod unit {
    ...
    fn device_uid_gid_ownership_in_container() {
        ...
        use edgerun_oci::OciLinuxDevice;
    ...
    fn time_namespace_accepted_by_validator() {
        ...
        use edgerun_oci::process::validate_spec;

        let spec = edgerun_oci::OciSpec {
            version: "1.0.2".into(),
            platform: None,
            process: Some(edgerun_oci::OciProcess {
            ...
            root: Some(edgerun_oci::OciRoot {
                path: "rootfs".into(), readonly: None,
            }),
            hostname: None,
            domainname: None,
            linux: Some(edgerun_oci::OciLinux {
                namespaces: Some(vec![
                    edgerun_oci::OciNamespace { ns_type: "time".into(), path: None },
                ]),
                ..Default::default()
            }),
    ...
    fn cgroup_weight_device_per_device_written() {
        ...
        use edgerun_oci::OciLinuxWeightDevice;
