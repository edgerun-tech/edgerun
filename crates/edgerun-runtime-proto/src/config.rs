...
mod tests {
    ...
    fn snippet_contains_runtime_and_snapshotter() {
        let rendered = render_containerd_snippet("/usr/bin/containerd-shim-edgerun-v2", "edgerun");
        ...
        assert!(rendered.contains("snapshotter = 'edgerun'"));
