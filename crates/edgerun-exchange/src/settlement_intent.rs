//! Protocol-native settlement intents for identity-routed node commands.
//!
//! HTTP provider APIs are upstream adapters only. Inside EdgeRun, marketplace
//! settlement requests converge on admitted work. This module carries rkyv
//! archives of concrete wallet protocol types inside `CommandEnvelope`.
