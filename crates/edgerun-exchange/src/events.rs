//! Exchange event model — ordered events that drive exchange projections.
//!
...
//! the exchange stream. Events are the local replay source for exchange state;
//! settlement authority should bind to admitted work and verifiable receipts.
//!
//! Event flow:
