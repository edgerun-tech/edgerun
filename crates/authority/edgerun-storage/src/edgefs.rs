...
//!
//! This initial implementation deliberately keeps durable local evidence in an
...
//! the log. Network authority still comes from admitted work and the proofs that
//! bind storage actions to it.
