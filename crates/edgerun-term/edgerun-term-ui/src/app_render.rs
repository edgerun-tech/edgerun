...
use crate::overlay;
use edgerun_term_core::gpu::{GlyphAtlas, GlyphVertex, GpuRenderer, RectVertex};
use edgerun_term_core::render::layout::LayoutMetrics;
use edgerun_term_core::render::primitives::fill_rect;
...
pub struct TabRender<'a> {
    pub title: &'a str,
    pub terminal: &'a edgerun_term_core::terminal::Terminal,
...
fn status_label_for_terminal(term: &edgerun_term_core::terminal::Terminal) -> Option<String> {
...
fn build_fps_in_tab_bar_gpu(
    rects: &mut Vec<edgerun_term_core::gpu::RectVertex>,
    glyphs_out: &mut Vec<edgerun_term_core::gpu::GlyphVertex>,
    atlas: &mut edgerun_term_core::gpu::GlyphAtlas,
