...
use edgerun_term_core::gpu::{GlyphAtlas, GlyphVertex, RectVertex};
use edgerun_term_core::render::GlyphCache;
use edgerun_term_core::render::primitives::{fill_rect, truncate_label};
...
pub fn list_panel_cpu(
    ...
    for (idx, (label, enabled)) in items.iter().enumerate() {
        ...
        edgerun_term_core::render::draw_text_line_clipped(
            glyphs,
            frame,
            width,
            height,
