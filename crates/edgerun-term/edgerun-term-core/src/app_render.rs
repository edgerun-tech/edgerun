...
use log::info;
use edgerun_term_core::debug::{DebugOverlay, DebugRenderMode, DebugRendererUsed};
use edgerun_term_core::render::layout::LayoutMetrics;
...
use edgerun_term_core::widgets::cheatsheet::{Cheatsheet, build_cheatsheet_gpu, draw_cheatsheet_cpu};
use edgerun_term_core::widgets::context::ContextMenu;
use edgerun_term_core::widgets::history::HistoryMenu;
use edgerun_term_core::widgets::settings::{SettingsPanel, build_settings_panel_gpu, draw_settings_panel_cpu};

use crate::{BORDER_INSET, BORDER_RADIUS, BORDER_THICKNESS, HelpToggle, Tab};
use edgerun_term_core::gpu::GpuRenderer;
use edgerun_term_core::render::overlay;
...
fn row_snapshot(term: &edgerun_term_core::terminal::Terminal, row: usize, cols: usize) -> String {
...
fn draw_scene(
    ...
    let bg = tabs
        ...
        .unwrap_or(edgerun_term_core::terminal::DEFAULT_BG);
...
fn draw_ghost_suggestion(
    term: &edgerun_term_core::terminal::Terminal,
    glyphs: &mut GlyphCache,
    frame: &mut [u8],
    frame_width: u32,
    frame_height: u32,
