...
pub use edgerun_term_core::render::GlyphCache;

pub mod primitives {
    pub use edgerun_term_core::render::primitives::*;
}

pub mod cpu {
    pub use edgerun_term_core::render::cpu::*;
}

pub mod layout {
    pub use edgerun_term_core::render::layout::*;
}

pub mod grid {
    pub use edgerun_term_core::render::grid::*;
}
...
pub const FONT_DATA: &[u8] = edgerun_term_core::render::FONT_DATA;
// Match the user's kitty config (JetBrainsMono Nerd Font 15px with 110% line height
// and 101% column width tweaks).
pub const FONT_SIZE: f32 = edgerun_term_core::render::FONT_SIZE;
pub const FONT_LINE_HEIGHT_ADJUST: f32 = edgerun_term_core::render::FONT_LINE_HEIGHT_ADJUST;
pub const FONT_COLUMN_ADJUST: f32 = edgerun_term_core::render::FONT_COLUMN_ADJUST;
