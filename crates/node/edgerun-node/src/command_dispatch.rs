//! Legacy local command validation and audit-event recording.
//!
//! This module keeps `edgerun-core` command streams usable as local evidence.
//! New cross-node work authority should enter through `edgerun-work`
//! admissions, routes, receipts, and proofs instead of extending this model.
...
pub fn project_config(
    ...
    Err("text node config was removed; project typed state from the local audit stream".into())
}
