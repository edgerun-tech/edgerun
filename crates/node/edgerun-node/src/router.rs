...
//! capability providers, and host transports. It decides local delivery and
//! resource realization for this runtime. Cross-node route authority comes from
//! admitted work. Apps do not bind ports, open shared memory, or directly own
