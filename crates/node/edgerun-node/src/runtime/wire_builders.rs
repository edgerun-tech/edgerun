...
use edgerun_protocols::wire::{
    ...
    runtime_storage_binding_id, CapabilityRequest, CapabilityResponseProofRecord,
    ...
    RuntimeStorageBinding, SigningCapabilityInputRecord, SigningResponsePayloadRecord,
    StorageWriteReceiptRecord, CAPABILITY_OPERATION_SIGN, RUNTIME_PROTOCOL_ACME,
    ...
    RUNTIME_PROTOCOL_TFTP, RUNTIME_SESSION_STATUS_OPEN, SDK_WIRE_ABI_VERSION,
};
