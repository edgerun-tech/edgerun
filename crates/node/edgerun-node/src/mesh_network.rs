...
//!
//! This is transport/test harness code for the legacy mesh path. Authoritative
//! user work should be routed through `edgerun-work` admission and channel
//! objects before it is treated as network work.
...
/// A mesh network that connects multiple legacy mesh nodes together.
///
