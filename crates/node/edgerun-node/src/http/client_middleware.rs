...
//!
//! ```text
//! use edgerun_node::http::client_middleware::{Chain, ClientMiddleware, ClientNext};
...
//! let auth = edgerun_node::http::client_middleware::client_middleware_fn(|req, next| {
//!     Box::pin(async move {
//!         let mut req = req;
...
///
/// ```text
/// let client = edgerun_node::http::client_middleware::Chain::new(edgerun_node::http::HttpClient::new())
///     .with(logging())
///     .with(retry(3))
///     .build();
/// ```
