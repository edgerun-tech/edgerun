...
//!
//! ```
//! use edgerun_node::http::middleware::{Chain, Middleware, Next};
//! use edgerun_node::http::{into_handler, Handler, Request, Response, StatusCode};
...
//! let cors = edgerun_node::http::middleware::middleware_fn(|req, next| {
//!     Box::pin(async move {
...
///
/// ```text
/// let handler = edgerun_node::http::middleware::Chain::new(my_handler)
///     .with(cors())      // outermost
///     .with(logging())
