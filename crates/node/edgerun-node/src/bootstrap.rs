...
//!
//! Bootstrap evidence is archived through the rkyv wire boundary and then
//! referenced by signed stream events. Any bootstrap fact that authorizes
//! cross-node work should still bind into admission policy.
