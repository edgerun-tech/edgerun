...
pub fn format_envelope(envelope: &crate::types::Envelope) -> String {
...
fn format_address_list(addrs: &[crate::types::Address]) -> String {
    if addrs.is_empty() {
...
fn format_address_list_opt(addr: &Option<crate::types::Address>) -> String {
    match addr {
...
fn format_address(addr: &crate::types::Address) -> String {
