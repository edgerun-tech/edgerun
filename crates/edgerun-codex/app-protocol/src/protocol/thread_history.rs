    ...
    fn reconstructs_tool_items_from_persisted_completion_events() {
        let events = vec![
            ...
            EventMsg::McpToolCallEnd(McpToolCallEndEvent {
                ...
                invocation: McpInvocation {
                    server: "docs".into(),
                    tool: "lookup".into(),
                    arguments: Some(edgerun_json::json!({"id":"123"})),
                },
        ...
        assert_eq!(
            ...
            ThreadItem::McpToolCall {
                ...
                arguments: edgerun_json::json!({"id":"123"}),
                mcp_app_resource_uri: None,
                result: None,
        ...
        let events = vec![
            ...
            EventMsg::McpToolCallEnd(McpToolCallEndEvent {
                ...
                result: Ok(CallToolResult {
                    ...
                    structured_content: Some(edgerun_json::json!({"id":"123"})),
                    is_error: Some(false),
        ...
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                codex_protocol::dynamic_tools::DynamicToolCallRequest {
                    ...
                    arguments: edgerun_json::json!({"id":"ABC-123"}),
                },
            ),
