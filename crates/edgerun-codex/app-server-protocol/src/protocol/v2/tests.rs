...
use codex_protocol::compat::absolute_path::test_support::PathBufExt;
use codex_protocol::compat::absolute_path::test_support::test_path_buf;
...
fn turn_defaults_legacy_missing_items_view_to_full() {
    let turn: Turn = edgerun_json::serde_json::from_value(json!({
        "id": "turn_123",
        "items": [],
        "status": "completed",
        "error": null,
...
fn thread_turns_list_params_accepts_items_view() {
    let params = edgerun_json::serde_json::from_value::<ThreadTurnsListParams>(json!({
        "threadId": "thr_123",
        "cursor": null,
        "limit": 25,
        "sortDirection": "desc",
...
fn thread_turns_items_list_round_trips() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(&params).expect("serialize params"),
        json!({
            "threadId": "thr_123",
            "turnId": "turn_456",
            "cursor": "cursor_1",
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(&response).expect("serialize response"),
        json!({
...
fn thread_list_params_accepts_single_cwd() {
    let params = edgerun_json::serde_json::from_value::<ThreadListParams>(json!({
        "cwd": "/workspace",
    }))
...
fn external_agent_config_plugins_details_round_trip() {
    let item: ExternalAgentConfigMigrationItem = edgerun_json::serde_json::from_value(json!({
        "itemType": "PLUGINS",
...
fn external_agent_config_import_params_accept_legacy_plugin_details() {
    let params: ExternalAgentConfigImportParams = edgerun_json::serde_json::from_value(json!({
        "migrationItems": [{
            "itemType": "PLUGINS",
            "description": "Install supported plugins from Claude settings",
            "cwd": absolute_path_string("repo"),
...
fn command_execution_request_approval_rejects_relative_additional_permission_paths() {
    let err = edgerun_json::serde_json::from_value::<CommandExecutionRequestApprovalParams>(json!({
        "threadId": "thr_123",
        "turnId": "turn_123",
        "itemId": "call_123",
        "startedAtMs": 1,
...
fn permissions_request_approval_uses_request_permission_profile() {
    ...
    let params = edgerun_json::serde_json::from_value::<PermissionsRequestApprovalParams>(json!({
        "threadId": "thr_123",
        "turnId": "turn_123",
        "itemId": "call_123",
        "startedAtMs": 1,
...
fn permissions_request_approval_rejects_macos_permissions() {
    let err = edgerun_json::serde_json::from_value::<PermissionsRequestApprovalParams>(json!({
        "threadId": "thr_123",
        "turnId": "turn_123",
        "itemId": "call_123",
        "startedAtMs": 1,
...
fn additional_file_system_permissions_rejects_zero_glob_scan_depth() {
    edgerun_json::serde_json::from_value::<AdditionalFileSystemPermissions>(json!({
        "read": null,
        "write": null,
        "globScanMaxDepth": 0,
        "entries": [],
...
fn permission_profile_file_system_permissions_rejects_zero_glob_scan_depth() {
    edgerun_json::serde_json::from_value::<PermissionProfileFileSystemPermissions>(json!({
        "type": "restricted",
        "entries": [],
        "globScanMaxDepth": 0,
    }))
...
fn legacy_current_working_directory_special_path_deserializes_as_project_roots() {
    let special_path = edgerun_json::serde_json::from_value::<FileSystemSpecialPath>(json!({
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(&special_path).expect("serialize special path"),
        json!({
            "kind": "project_roots",
            "subpath": null,
        })
...
fn permissions_request_approval_response_uses_granted_permission_profile_without_macos() {
    ...
    let response = edgerun_json::serde_json::from_value::<PermissionsRequestApprovalResponse>(json!({
        "permissions": {
            "network": {
                "enabled": true,
            },
...
fn fs_get_metadata_response_round_trips_minimal_fields() {
    ...
    let value = edgerun_json::serde_json::to_value(&response).expect("serialize fs/getMetadata response");
    assert_eq!(
        value,
        json!({
            "isDirectory": false,
    ...
    let decoded = edgerun_json::serde_json::from_value::<FsGetMetadataResponse>(value)
...
fn fs_read_file_response_round_trips_base64_data() {
    ...
    let value = edgerun_json::serde_json::to_value(&response).expect("serialize fs/readFile response");
    assert_eq!(
        value,
        json!({
            "dataBase64": "aGVsbG8=",
    ...
    let decoded = edgerun_json::serde_json::from_value::<FsReadFileResponse>(value)
...
fn fs_read_file_params_round_trip() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize fs/readFile params");
    assert_eq!(
        value,
        json!({
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<FsReadFileParams>(value).expect("deserialize fs/readFile params");
...
fn fs_create_directory_params_round_trip_with_default_recursive() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize fs/createDirectory params");
    assert_eq!(
        value,
        json!({
    ...
    let decoded = edgerun_json::serde_json::from_value::<FsCreateDirectoryParams>(value)
...
fn fs_write_file_params_round_trip_with_base64_data() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize fs/writeFile params");
    assert_eq!(
        value,
        json!({
    ...
    let decoded = edgerun_json::serde_json::from_value::<FsWriteFileParams>(value)
...
fn fs_copy_params_round_trip_with_recursive_directory_copy() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize fs/copy params");
    assert_eq!(
        value,
        json!({
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<FsCopyParams>(value).expect("deserialize fs/copy params");
    assert_eq!(decoded, params);
}
...
fn thread_shell_command_params_round_trip() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize thread/shellCommand params");
    assert_eq!(
        value,
        json!({
            "threadId": "thr_123",
    ...
    let decoded = edgerun_json::serde_json::from_value::<ThreadShellCommandParams>(value)
...
fn thread_shell_command_response_round_trip() {
    ...
    let value = edgerun_json::serde_json::to_value(&response).expect("serialize thread/shellCommand response");
    assert_eq!(value, json!({}));

    let decoded = edgerun_json::serde_json::from_value::<ThreadShellCommandResponse>(value)
...
fn fs_changed_notification_round_trips() {
    ...
    let value = edgerun_json::serde_json::to_value(&notification).expect("serialize fs/changed notification");
    assert_eq!(
        value,
        json!({
    ...
    let decoded = edgerun_json::serde_json::from_value::<FsChangedNotification>(value)
...
fn command_exec_params_default_optional_streaming_flags() {
    let params = edgerun_json::serde_json::from_value::<CommandExecParams>(json!({
        "command": ["ls", "-la"],
        "timeoutMs": 1000,
        "cwd": "/tmp"
    }))
...
fn command_exec_params_round_trips_disable_timeout() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize command/exec params");
    assert_eq!(
        value,
        json!({
            "command": ["sleep", "30"],
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<CommandExecParams>(value).expect("deserialize round-trip");
    assert_eq!(decoded, params);
}
...
fn process_spawn_params_round_trips_without_sandbox_policy() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize process/spawn params");
    assert_eq!(
        value,
        json!({
            "command": ["sleep", "30"],
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<ProcessSpawnParams>(value).expect("deserialize round-trip");
    assert_eq!(decoded, params);
}
...
fn process_spawn_params_distinguish_omitted_null_and_value_limits() {
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<ProcessSpawnParams>(base).expect("deserialize omitted limits");
    assert_eq!(decoded, expected_omitted);

    let decoded = edgerun_json::serde_json::from_value::<ProcessSpawnParams>(json!({
        "command": ["sleep", "30"],
        "processHandle": "sleep-1",
        "cwd": absolute_path_string("readable"),
        "outputBytesCap": null,
...
fn command_exec_write_round_trips_close_only_payload() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize command/exec/write params");
    assert_eq!(
        value,
        json!({
            "processId": "proc-7",
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<CommandExecWriteParams>(value).expect("deserialize round-trip");
    assert_eq!(decoded, params);
}
...
fn command_exec_terminate_round_trips() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize command/exec/terminate params");
    assert_eq!(
        value,
        json!({
            "processId": "proc-8",
    ...
    let decoded = edgerun_json::serde_json::from_value::<CommandExecTerminateParams>(value)
...
fn command_exec_resize_round_trips() {
    ...
    let value = edgerun_json::serde_json::to_value(&params).expect("serialize command/exec/resize params");
    assert_eq!(
        value,
        json!({
            "processId": "proc-9",
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<CommandExecResizeParams>(value).expect("deserialize round-trip");
    assert_eq!(decoded, params);
}
...
fn command_exec_output_delta_round_trips() {
    ...
    let value = edgerun_json::serde_json::to_value(&notification)
    ...
    let decoded = edgerun_json::serde_json::from_value::<CommandExecOutputDeltaNotification>(value)
        .expect("deserialize round-trip");
    assert_eq!(decoded, notification);
}
...
fn process_control_params_round_trip() {
    ...
    let value = edgerun_json::serde_json::to_value(&write).expect("serialize process/writeStdin params");
    assert_eq!(
        value,
        json!({
    ...
    let decoded = edgerun_json::serde_json::from_value::<ProcessWriteStdinParams>(value)
    ...
    let value = edgerun_json::serde_json::to_value(&resize).expect("serialize process/resizePty params");
    assert_eq!(
        value,
        json!({
            "processHandle": "proc-7",
    ...
    let decoded = edgerun_json::serde_json::from_value::<ProcessResizePtyParams>(value)
    ...
    let value = edgerun_json::serde_json::to_value(&kill).expect("serialize process/kill params");
    assert_eq!(
        value,
        json!({
            "processHandle": "proc-7",
    ...
    let decoded =
        edgerun_json::serde_json::from_value::<ProcessKillParams>(value).expect("deserialize process/kill");
...
fn process_notifications_round_trip() {
    ...
    let value = edgerun_json::serde_json::to_value(&delta).expect("serialize process/outputDelta");
    assert_eq!(
        value,
        json!({
    ...
    let decoded = edgerun_json::serde_json::from_value::<ProcessOutputDeltaNotification>(value)
    ...
    let value = edgerun_json::serde_json::to_value(&exited).expect("serialize process/exited");
    assert_eq!(
        value,
        json!({
            "processHandle": "proc-1",
    ...
    let decoded = edgerun_json::serde_json::from_value::<ProcessExitedNotification>(value)
...
fn command_execution_output_delta_round_trips() {
    ...
    let decoded = edgerun_json::serde_json::from_value::<CommandExecutionOutputDeltaNotification>(value)
        .expect("deserialize round-trip");
    assert_eq!(decoded, notification);
}
...
fn ask_for_approval_granular_defaults_missing_optional_flags_to_false() {
    let decoded = edgerun_json::serde_json::from_value::<AskForApproval>(edgerun_json::serde_json::json!({
        "granular": {
            "sandbox_approval": true,
            "rules": false,
...
fn mcp_server_elicitation_request_from_core_form_request() {
    ...
    let expected_schema: McpElicitationSchema = edgerun_json::serde_json::from_value(json!({
        "type": "object",
        "properties": {
            "confirmed": {
                "type": "boolean",
...
fn mcp_elicitation_schema_matches_mcp_2025_11_25_primitives() {
    let schema: McpElicitationSchema = edgerun_json::serde_json::from_value(json!({
...
fn mcp_server_elicitation_response_serializes_nullable_content() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(response).expect("response should serialize"),
        json!({
            "action": "decline",
            "content": null,
            "_meta": null,
...
fn sandbox_policy_deserializes_legacy_read_only_full_access_field() {
    let policy = edgerun_json::serde_json::from_value::<SandboxPolicy>(json!({
        "type": "readOnly",
        "access": {
            "type": "fullAccess"
        },
...
fn sandbox_policy_rejects_legacy_read_only_restricted_access_field() {
    let err = edgerun_json::serde_json::from_value::<SandboxPolicy>(json!({
        "type": "readOnly",
        "access": {
            "type": "restricted",
...
fn automatic_approval_review_deserializes_aborted_status() {
    let review: GuardianApprovalReview = edgerun_json::serde_json::from_value(json!({
        "status": "aborted",
        "riskLevel": null,
...
fn guardian_approval_review_action_round_trips_command_shape() {
    ...
    let action: GuardianApprovalReviewAction =
        edgerun_json::serde_json::from_value(value.clone()).expect("guardian review action");
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(&action).expect("serialize guardian review action"),
        value
    );
}
...
fn network_requirements_deserializes_legacy_fields() {
    let requirements: NetworkRequirements = edgerun_json::serde_json::from_value(json!({
...
fn network_requirements_serializes_canonical_and_legacy_fields() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(requirements).expect("network requirements should serialize"),
        json!({
            "enabled": true,
            "httpPort": 8080,
            "socksPort": 1080,
...
fn skills_list_params_serialization_uses_force_reload() {
    assert_eq!(
        edgerun_json::serde_json::to_value(SkillsListParams {
            cwds: Vec::new(),
            force_reload: false,
...
fn plugin_source_serializes_local_git_and_remote_variants() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginSource::Local { path: local_path }).unwrap(),
        json!({
            "type": "local",
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginSource::Git {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginSource::Remote).unwrap(),
        json!({
            "type": "remote",
        }),
    );
...
fn marketplace_add_params_serialization_uses_optional_ref_name_and_sparse_paths() {
    assert_eq!(
        edgerun_json::serde_json::to_value(MarketplaceAddParams {
...
fn marketplace_upgrade_params_serialization_uses_optional_marketplace_name() {
    assert_eq!(
        edgerun_json::serde_json::to_value(MarketplaceUpgradeParams {
    ...
    assert_eq!(
        edgerun_json::serde_json::from_value::<MarketplaceUpgradeParams>(json!({})).unwrap(),
...
fn plugin_marketplace_entry_serializes_remote_only_path_as_null() {
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginMarketplaceEntry {
...
fn plugin_interface_serializes_local_paths_and_remote_urls_separately() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(interface).unwrap(),
        json!({
            "displayName": "Linear",
...
fn plugin_list_params_ignore_removed_force_remote_sync_field() {
    assert_eq!(
        edgerun_json::serde_json::from_value::<PluginListParams>(json!({
            "cwds": null,
...
fn plugin_list_params_serializes_marketplace_kind_filter() {
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginListParams {
            cwds: None,
...
fn plugin_read_params_serialization_uses_install_source_fields() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginReadParams {
    ...
    assert_eq!(
        edgerun_json::serde_json::from_value::<PluginReadParams>(json!({
            "marketplacePath": marketplace_path_json,
            "pluginName": "gmail",
            "forceRemoteSync": true,
        }))
...
fn plugin_install_params_serialization_omits_force_remote_sync() {
    ...
    let marketplace_path_json = marketplace_path.as_path().display().to_string();
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginInstallParams {
            marketplace_path: Some(marketplace_path.clone()),
            remote_marketplace_name: None,
            plugin_name: "gmail".to_string(),
        })
    ...
    assert_eq!(
        edgerun_json::serde_json::from_value::<PluginInstallParams>(json!({
            "marketplacePath": marketplace_path_json,
            "pluginName": "gmail",
            "forceRemoteSync": true,
        }))
...
fn plugin_skill_read_params_serialization_uses_remote_plugin_id() {
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginSkillReadParams {
...
fn plugin_share_params_and_response_serialization_use_camel_case_fields() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareSaveParams {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareSaveResponse {
            remote_plugin_id: "plugins~Plugin_00000000000000000000000000000000".to_string(),
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareUpdateTargetsParams {
            remote_plugin_id: "plugins~Plugin_00000000000000000000000000000000".to_string(),
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareUpdateTargetsResponse {
    ...
    assert_eq!(
        edgerun_json::serde_json::from_value::<PluginShareListParams>(json!({})).unwrap(),
        PluginShareListParams {},
    );

    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareDeleteParams {
            remote_plugin_id: "plugins~Plugin_00000000000000000000000000000000".to_string(),
        })
        .unwrap(),
        json!({
...
fn plugin_share_list_response_serializes_share_items() {
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginShareListResponse {
...
fn plugin_summary_defaults_missing_availability_to_available() {
    let summary: PluginSummary = edgerun_json::serde_json::from_value(json!({
        "id": "plugins~Plugin_00000000000000000000000000000000",
        "name": "gmail",
        "source": { "type": "remote" },
        "installed": false,
...
fn plugin_availability_deserializes_enabled_alias() {
    let availability: PluginAvailability = edgerun_json::serde_json::from_value(json!("ENABLED")).unwrap();

    assert_eq!(availability, PluginAvailability::Available);
    assert_eq!(
        edgerun_json::serde_json::to_value(availability).unwrap(),
        json!("AVAILABLE")
    );
}
...
fn plugin_uninstall_params_serialization_omits_force_remote_sync() {
    assert_eq!(
        edgerun_json::serde_json::to_value(PluginUninstallParams {
    ...
    assert_eq!(
        edgerun_json::serde_json::from_value::<PluginUninstallParams>(json!({
            "pluginId": "gmail@openai-curated",
            "forceRemoteSync": true,
        }))
        .unwrap(),
...
fn marketplace_remove_response_serializes_nullable_installed_root() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(MarketplaceRemoveResponse {
...
fn marketplace_upgrade_response_serializes_camel_case_fields() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(MarketplaceUpgradeResponse {
...
fn codex_error_info_serializes_http_status_code_in_camel_case() {
    ...
    assert_eq!(
        edgerun_json::serde_json::to_value(value).unwrap(),
        json!({
...
fn codex_error_info_serializes_cyber_policy_in_camel_case() {
    assert_eq!(
        edgerun_json::serde_json::to_value(CodexErrorInfo::CyberPolicy).unwrap(),
        json!("cyberPolicy")
    );
}
...
fn dynamic_tool_response_serializes_content_items() {
    let value = edgerun_json::serde_json::to_value(DynamicToolCallResponse {
...
fn thread_start_params_preserve_explicit_null_service_tier() {
    let params: ThreadStartParams =
        edgerun_json::serde_json::from_value(json!({ "serviceTier": null })).expect("params should deserialize");
    assert_eq!(params.service_tier, Some(None));

    let serialized = edgerun_json::serde_json::to_value(&params).expect("params should serialize");
    assert_eq!(
        serialized.get("serviceTier"),
        Some(&edgerun_json::serde_json::Value::Null)
    );

    let serialized_without_override =
        edgerun_json::serde_json::to_value(ThreadStartParams::default()).expect("params should serialize");
...
fn thread_lifecycle_responses_default_missing_optional_fields() {
    ...
    let start: ThreadStartResponse =
        edgerun_json::serde_json::from_value(response.clone()).expect("thread/start response");
    let resume: ThreadResumeResponse =
        edgerun_json::serde_json::from_value(response.clone()).expect("thread/resume response");
    let fork: ThreadForkResponse = edgerun_json::serde_json::from_value(response).expect("thread/fork response");
...
fn turn_start_params_preserve_explicit_null_service_tier() {
    let params: TurnStartParams = edgerun_json::serde_json::from_value(json!({
        "threadId": "thread_123",
        "input": [],
        "serviceTier": null
    }))
    ...
    let serialized_without_override =
        edgerun_json::serde_json::to_value(&without_override).expect("params should serialize");
    assert_eq!(serialized_without_override.get("serviceTier"), None);
}
...
fn turn_start_params_treat_null_or_omitted_environments_as_default() {
    let null_environments: TurnStartParams = edgerun_json::serde_json::from_value(json!({
        "threadId": "thread_123",
        "input": [],
        "environments": null,
    }))
    .expect("params should deserialize");
    let omitted_environments: TurnStartParams = edgerun_json::serde_json::from_value(json!({
        "threadId": "thread_123",
        "input": [],
    }))
    .expect("params should deserialize");
...
fn turn_start_params_reject_relative_environment_cwd() {
    let err = edgerun_json::serde_json::from_value::<TurnStartParams>(json!({
        "threadId": "thread_123",
        "input": [],
        "environments": [
            {
