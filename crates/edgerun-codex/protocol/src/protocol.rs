    ...
    pub fn token_budget(&self) -> usize {
        match self {
            TruncationPolicy::Bytes(bytes) => usize::try_from(
                crate::compat::strings::approx_tokens_from_byte_count(*bytes),
            )
            .unwrap_or(usize::MAX),
    ...
    pub fn byte_budget(&self) -> usize {
        match self {
            ...
            TruncationPolicy::Tokens(tokens) => {
                crate::compat::strings::approx_bytes_for_tokens(*tokens)
            }
        }
    }
}
...
mod tests {
    ...
    fn restricted_file_system_policy_treats_root_with_carveouts_as_scoped_access() {
        ...
        let canonical_cwd =
            crate::compat::absolute_path::canonicalize_preserving_symlinks(cwd.path())
