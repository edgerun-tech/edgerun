...
impl FromStr for ReasoningEffort {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ReasoningEffort::from_json(edgerun_json::JsonValue::String(s.to_string()))
...
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq, Eq, ToJson, FromJson)]
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq, TS, JsonSchema, ToJson, FromJson)]
...
mod tests {
    ...
    fn model_info_defaults_availability_nux_to_none_when_omitted() {
        let model: ModelInfo = edgerun_json::from_serde_value(edgerun_json::json!({
            "slug": "test-model",
