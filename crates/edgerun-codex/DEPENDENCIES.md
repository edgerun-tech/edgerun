...
| `codex-core` | `codex-api`, `codex-apply-patch`, `codex-model-provider`, `codex-model-provider-info`, `codex-models-manager`, `codex-protocol`, `codex-shell-command`, `codex-tools`, `edgerun-json`, `thiserror` |
