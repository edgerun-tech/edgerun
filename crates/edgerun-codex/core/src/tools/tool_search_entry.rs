...
fn mcp_tool_search_entry(info: &ToolInfo) -> Result<ToolSearchEntry, edgerun_json::Error> {
    Ok(ToolSearchEntry {
...
fn dynamic_tool_search_entry(tool: &DynamicToolSpec) -> Result<ToolSearchEntry, edgerun_json::Error> {
    Ok(ToolSearchEntry {
