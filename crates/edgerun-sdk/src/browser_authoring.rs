...
use edgerun_crypto::{Ed25519SigningKey as SigningKey, Ed25519VerifyingKey};
use edgerun_wire::{
    ...
    AppStoreSubmissionRecord, ArtifactSignature, PackageCacheRecord, RuntimeAppInstall,
    RuntimeCapabilityDeclaration, RuntimeEvent, SdkWireRecord,
    APP_RUN_DECISION_VERIFY_AND_CACHE, PACKAGE_CACHE_STATE_VERIFIED,
...
fn decode_app_manifest(bytes: &[u8]) -> Result<AppManifestRecord, String> {
    match edgerun_wire::from_bytes::<SdkWireRecord, edgerun_wire::WireError>(&bytes.to_vec())
