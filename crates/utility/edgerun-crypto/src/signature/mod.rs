...
#[cfg(feature = "signature_digest")]
mod prehash_signature;

pub use crate::signature::{encoding::*, error::*, keypair::*, signer::*, verifier::*};

#[cfg(feature = "signature_derive")]
pub use derive::{Signer, Verifier};

#[cfg(all(feature = "signature_derive", feature = "signature_digest"))]
pub use derive::{DigestSigner, DigestVerifier};

#[cfg(feature = "signature_digest")]
pub use {crate::digest, crate::signature::prehash_signature::*};

#[cfg(feature = "signature_rand_core")]
