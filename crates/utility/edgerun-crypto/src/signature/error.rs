...
impl From<crate::rand_core::Error> for Error {
    #[cfg(not(feature = "signature_std"))]
    fn from(_source: crate::rand_core::Error) -> Error {
        Error::new()
    }

    #[cfg(feature = "signature_std")]
    fn from(source: crate::rand_core::Error) -> Error {
