...
//!
//! ```
//! use edgerun_crypto::zeroize::Zeroize;
//!
...
//! # {
//! use edgerun_crypto::zeroize::{Zeroize, ZeroizeOnDrop};
//!
...
//! # #[cfg(feature = "zeroize_derive")]
//! # {
//! use edgerun_crypto::zeroize::ZeroizeOnDrop;
//!
//! // This struct will be zeroized on drop
...
//!
//! ```
//! use edgerun_crypto::zeroize::Zeroizing;
//!
//! fn use_secret() {
...
/// ```
/// use edgerun_crypto::zeroize::{ZeroizeOnDrop, zeroize_flat_type};
///
