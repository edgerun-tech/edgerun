    ...
    fn decode_value<R: Reader<'a>>(reader: &mut R, header: Header) -> crate::der::Result<Self> {
        reader.read_nested(header.length, |reader| {
            ...
            if version.is_multi() != result.other_prime_infos.is_some() {
                return Err(reader.error(crate::der::ErrorKind::Value { tag: Tag::Integer }));
            }
...
impl EncodeValue for RsaPrivateKey<'_> {
    ...
    fn encode_value(&self, writer: &mut impl Writer) -> crate::der::Result<()> {
...
impl<'a> DecodeValue<'a> for OtherPrimeInfos<'a> {
    fn decode_value<R: Reader<'a>>(reader: &mut R, _header: Header) -> crate::der::Result<Self> {
        ...
        Err(reader.error(crate::der::ErrorKind::Value { tag: Tag::Integer }))
    }
}
...
impl EncodeValue for OtherPrimeInfos<'_> {
    fn value_len(&self) -> crate::der::Result<Length> {
        // Placeholder decoder that always returns an error.
        // Uses `Tag::Integer` to signal an unsupported version.
        Err(crate::der::ErrorKind::Value { tag: Tag::Integer }.into())
    }

    fn encode_value(&self, _writer: &mut impl Writer) -> crate::der::Result<()> {
        // Placeholder decoder that always returns an error.
        // Uses `Tag::Integer` to signal an unsupported version.
        Err(crate::der::ErrorKind::Value { tag: Tag::Integer }.into())
    }
...
#[cfg(not(feature = "rsa"))]
impl<'a> crate::der::FixedTag for OtherPrimeInfos<'a> {
