...
use crate::pkcs1::Result;

#[cfg(feature = "rsa")]
use crate::der::{Document, SecretDocument};
...
#[cfg(all(feature = "rsa", feature = "rsa"))]
use crate::der::Decode;

#[cfg(all(feature = "rsa", any(feature = "rsa_pem", feature = "rsa")))]
use crate::pkcs1::{RsaPrivateKey, RsaPublicKey};
...
#[cfg(all(feature = "rsa", feature = "rsa"))]
impl<T: crate::pkcs8::EncodePrivateKey> EncodeRsaPrivateKey for T {
    fn to_pkcs1_der(&self) -> Result<SecretDocument> {
        let pkcs8_doc = self.to_pkcs8_der()?;
        let pkcs8_key = crate::pkcs8::PrivateKeyInfo::from_der(pkcs8_doc.as_bytes())?;
...
#[cfg(all(feature = "rsa", feature = "rsa"))]
impl<T: crate::pkcs8::EncodePublicKey> EncodeRsaPublicKey for T {
    fn to_pkcs1_der(&self) -> Result<Document> {
        let doc = self.to_public_key_der()?;
        let spki = crate::pkcs8::SubjectPublicKeyInfoRef::from_der(doc.as_bytes())?;
