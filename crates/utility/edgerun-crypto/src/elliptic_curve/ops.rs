...
use crate::crypto_bigint::Integer;
use crate::group::Group;
use crate::subtle::{Choice, ConditionallySelectable, CtOption};
...
pub trait LinearCombinationExt<PointsAndScalars>: crate::group::Curve
where
...
/// [`NonZeroScalar`][`crate::elliptic_curve::NonZeroScalar`] instead.
