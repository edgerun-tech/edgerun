...
use crate::elliptic_curve::{CurveArithmetic, ProjectivePoint, Result};
    ...
    ProjectivePoint<Self>: CofactorGroup,
{
    ...
    ///
    /// ```ignore
    /// let pt = ProjectivePoint::hash_from_bytes::<ExpandMsgXmd<crate::sha2::Sha256>>(b"test data", b"CURVE_XMD:SHA-256_SSWU_RO_");
    /// ```
    ///
    ...
    ///
    /// [`ExpandMsgXmd`]: crate::elliptic_curve::hash2curve::ExpandMsgXmd
    /// [`ExpandMsgXof`]: crate::elliptic_curve::hash2curve::ExpandMsgXof
