...
use crate::elliptic_curve::JwkParameters;
...
/// SEC1 encoded point.
pub type EncodedPoint = crate::elliptic_curve::sec1::EncodedPoint<MockCurve>;

/// Field element bytes.
pub type FieldBytes = crate::elliptic_curve::FieldBytes<MockCurve>;

/// Non-zero scalar value.
pub type NonZeroScalar = crate::elliptic_curve::NonZeroScalar<MockCurve>;

/// Public key.
pub type PublicKey = crate::elliptic_curve::PublicKey<MockCurve>;

/// Secret key.
pub type SecretKey = crate::elliptic_curve::SecretKey<MockCurve>;

/// Scalar primitive type.
// TODO(tarcieri): make this the scalar type when it's more capable
pub type ScalarPrimitive = crate::elliptic_curve::ScalarPrimitive<MockCurve>;

/// Scalar bits.
#[cfg(feature = "elliptic_curve_bits")]
pub type ScalarBits = crate::elliptic_curve::scalar::ScalarBits<MockCurve>;
...
impl From<ProjectivePoint> for AffinePoint {
    fn from(point: ProjectivePoint) -> AffinePoint {
        crate::group::Curve::to_affine(&point)
    }
}
...
impl crate::group::Group for ProjectivePoint {
    type Scalar = Scalar;
...
impl crate::group::GroupEncoding for AffinePoint {
...
impl crate::group::GroupEncoding for ProjectivePoint {
    type Repr = CompressedPoint<MockCurve>;

    fn from_bytes(bytes: &Self::Repr) -> CtOption<Self> {
        <AffinePoint as crate::group::GroupEncoding>::from_bytes(bytes).map(Into::into)
    }
    ...
    fn to_bytes(&self) -> Self::Repr {
        crate::group::Curve::to_affine(self).to_bytes()
    }
}

impl crate::group::Curve for ProjectivePoint {
