...
#[cfg(feature = "elliptic_curve_arithmetic")]
pub use {self::non_identity::NonIdentity, crate::elliptic_curve::CurveArithmetic};

use crate::elliptic_curve::{Curve, FieldBytes};
...
#[cfg(feature = "elliptic_curve_arithmetic")]
pub trait BatchNormalize<Points: ?Sized>: crate::group::Curve {
