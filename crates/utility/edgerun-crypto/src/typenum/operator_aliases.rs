...
pub type Add1<A> = <A as Add<crate::typenum::bit::B1>>::Output;
pub type Sub1<A> = <A as Sub<crate::typenum::bit::B1>>::Output;

pub type Double<A> = Shleft<A, crate::typenum::bit::B1>;
