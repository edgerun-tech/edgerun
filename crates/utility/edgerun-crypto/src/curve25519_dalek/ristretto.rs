...
//! `crate::subtle::ConstantTimeEq` trait for constant-time equality
...
#[cfg(any(curve25519_dalek_upstream_tests, feature = "rand_core"))]
...
impl RistrettoPoint {
    ...
    /// in a batch.
    ///
    #[cfg_attr(feature = "rand_core", doc = "```ignore")]
    ...
    /// # Example
    ///
    #[cfg_attr(feature = "digest", doc = "```ignore")]
