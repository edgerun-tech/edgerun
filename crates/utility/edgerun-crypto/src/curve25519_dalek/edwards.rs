...
//! ## Equality Testing
//!
//! The `EdwardsPoint` struct implements the [`crate::subtle::ConstantTimeEq`]
...
use crate::curve25519_dalek::backend::serial::curve_models::AffineNielsPoint;
...
#[cfg(feature = "alloc")]
use crate::curve25519_dalek::traits::{VartimeMultiscalarMul, VartimePrecomputedMultiscalarMul};
...
impl EdwardsPoint {
        ...
        D: Digest<OutputSize = U64> + Default,
    {
        ...
        let M1 = crate::curve25519_dalek::montgomery::elligator_encode(&fe);
...
impl MultiscalarMul for EdwardsPoint {
        ...
        J::Item: Borrow<EdwardsPoint>,
    {
        ...
        crate::curve25519_dalek::backend::straus_multiscalar_mul(scalars, points)
    }
}
...
impl VartimeMultiscalarMul for EdwardsPoint {
        ...
        J: IntoIterator<Item = Option<EdwardsPoint>>,
    {
        ...
        if size < 190 {
            crate::curve25519_dalek::backend::straus_optional_multiscalar_mul(scalars, points)
        } else {
            crate::curve25519_dalek::backend::pippenger_optional_multiscalar_mul(scalars, points)
        }
    }
}
...
// outer type.
#[cfg(feature = "alloc")]
pub struct VartimeEdwardsPrecomputation(crate::curve25519_dalek::backend::VartimePrecomputedStraus);
...
impl VartimePrecomputedMultiscalarMul for VartimeEdwardsPrecomputation {
    ...
    {
        Self(crate::curve25519_dalek::backend::VartimePrecomputedStraus::new(static_points))
    }
