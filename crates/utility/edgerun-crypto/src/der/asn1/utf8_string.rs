...
#[cfg(feature = "alloc")]
use {
    crate::der::{DecodeValue, Header, Reader},
...
///
/// Note that the [`Decode`][`crate::der::Decode`] and [`Encode`][`crate::der::Encode`]
...
/// [`PrintableStringRef`][`crate::der::asn1::PrintableStringRef`].
///
