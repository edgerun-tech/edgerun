...
/// [`Encoding`][`crate::crypto_bigint::Encoding`] trait or various `const fn` decoding and
/// encoding functions that can be used with [`Uint`] constants.
///
/// Optional crate features for encoding (off-by-default):
/// - `generic-array`: enables [`ArrayEncoding`][`crate::crypto_bigint::ArrayEncoding`] trait which can be used to
///   [`Uint`] as `GenericArray<u8, N>` and a [`ArrayDecoding`][`crate::crypto_bigint::ArrayDecoding`] trait which
...
mod tests {
    use crate::crypto_bigint::{Encoding, U128};
