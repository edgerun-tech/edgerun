...
///
/// ```
/// const _: () = edgerun_crypto::const_assert_eq!(0, 0, "zero equals zero");
/// ```
#[macro_export]
...
///
/// ```
/// const _: () = edgerun_crypto::const_assert_ne!(0, 1, "zero is NOT equal to one");
/// ```
#[macro_export]
...
macro_rules! nlimbs {
    ($bits:expr) => {
        $bits / $crate::crypto_bigint::Limb::BITS
    };
}
