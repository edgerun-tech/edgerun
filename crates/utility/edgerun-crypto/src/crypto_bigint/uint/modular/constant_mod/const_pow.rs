...
use crate::crypto_bigint::modular::pow::multi_exponentiate_montgomery_form_array;
...
mod tests {
    ...
    fn test_multi_exp_array() {
        ...
        let res =
            crate::crypto_bigint::modular::constant_mod::Residue::<Modulus, { U256::LIMBS }>::multi_exponentiate(
                &bases_and_exponents,
            );
