...
//! # #[cfg(all(feature = "rsa_pem", feature = "std"))]
//! # {
...
//! toplevel of the `rsa` crate:
//!
//! - [`crate::pkcs8::DecodePrivateKey`]: decode private keys from PKCS#8
//! - [`crate::pkcs8::EncodePrivateKey`]: encode private keys to PKCS#8
//! - [`crate::pkcs8::DecodePublicKey`]: decode public keys from PKCS#8
//! - [`crate::pkcs8::EncodePublicKey`]: encode public keys to PKCS#8
//!
//! ### Example
//!
//! ```ignore
...
//! # #[cfg(all(feature = "rsa_pem", feature = "std"))]
//! # {
//! use rsa::{RsaPublicKey, crate::pkcs8::DecodePublicKey};
//!
...
//! [`crate::pkcs8::DecodePublicKey`]: https://docs.rs/pkcs8/latest/pkcs8/trait.DecodePublicKey.html
//! [`crate::pkcs8::EncodePublicKey`]: https://docs.rs/pkcs8/latest/pkcs8/trait.EncodePublicKey.html
