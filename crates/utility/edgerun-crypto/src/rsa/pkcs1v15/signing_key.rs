...
where
    D: Digest,
{
    fn try_sign_digest(&self, digest: D) -> crate::signature::Result<Signature> {
...
where
    D: Digest,
{
    fn sign_prehash(&self, prehash: &[u8]) -> crate::signature::Result<Signature> {
    ...
    D: Digest,
{
    fn try_sign_digest_with_rng(
        ...
        digest: D,
    ) -> crate::signature::Result<Signature> {
...
where
    D: Digest,
{
    fn try_sign(&self, msg: &[u8]) -> crate::signature::Result<Signature> {
...
impl<D> TryFrom<crate::pkcs8::PrivateKeyInfo<'_>> for SigningKey<D>
where
    D: Digest + AssociatedOid,
{
