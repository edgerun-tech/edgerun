...
//! ```ignore
//!
//! [`BlockRngCore`]: crate::rand_core::block::BlockRngCore
//! [`fill_bytes`]: RngCore::fill_bytes

use crate::rand_core::impls::{fill_via_u32_chunks, fill_via_u64_chunks};
...
///
/// See the [module][crate::rand_core::block] documentation for details.
...
#[cfg(test)]
mod test {
    use crate::rand_core::block::{BlockRng, BlockRng64, BlockRngCore};
