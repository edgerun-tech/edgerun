...
use crate::num_bigint::{Float, Num, NumCast};
...
pub trait Real: Num + Copy + NumCast + PartialOrd + Neg<Output = Self> {
    ...
    //
    // ```
    // use crate::num_bigint::real::Real;
    // use std::f64;
    //
    ...
    // assert!(abs_difference_y < 1e-10);
    //
    // assert!(::crate::num_bigint::Float::is_nan(f64::NAN.abs()));
    // ```
    fn abs(self) -> Self;
    ...
    //
    // assert!(abs_difference < 1e-10);
    // assert!(::crate::num_bigint::Float::is_nan(negative.sqrt()));
    // ```
    fn sqrt(self) -> Self;
