...
use crate::num_bigint::bounds::Bounded;
use crate::num_bigint::ops::checked::*;
use crate::num_bigint::ops::saturating::Saturating;
use crate::num_bigint::{Num, NumCast};
...
mod tests {
    use crate::num_bigint::int::PrimInt;
