...
impl Euclid for f32 {
    ...
    fn div_euclid(&self, v: &f32) -> f32 {
        let q = <f32 as crate::num_bigint::float::FloatCore>::trunc(self / v);
        if self % v < 0.0 {
    ...
    fn rem_euclid(&self, v: &f32) -> f32 {
        let r = self % v;
        if r < 0.0 {
            r + <f32 as crate::num_bigint::float::FloatCore>::abs(*v)
        } else {
            r
        }
    }
...
impl Euclid for f64 {
    ...
    fn div_euclid(&self, v: &f64) -> f64 {
        let q = <f64 as crate::num_bigint::float::FloatCore>::trunc(self / v);
        if self % v < 0.0 {
            return if *v > 0.0 { q - 1.0 } else { q + 1.0 };
        }
        q
    ...
    fn rem_euclid(&self, v: &f64) -> f64 {
        let r = self % v;
        if r < 0.0 {
            r + <f64 as crate::num_bigint::float::FloatCore>::abs(*v)
        } else {
            r
        }
    }
...
pub trait CheckedEuclid: Euclid {
    ...
    //
    // ```
    // # use crate::num_bigint::CheckedEuclid;
    // let x = 5u8;
    // let y = 3u8;
    //
                ...
                $(
                    {
                        ...
                        <= 46.4 * <$t as crate::num_bigint::float::FloatCore>::epsilon());
                        assert!(Euclid::div_euclid(&x, &-y) * -y + Euclid::rem_euclid(&x, &-y) - x
                        <= 46.4 * <$t as crate::num_bigint::float::FloatCore>::epsilon());
                        assert!(Euclid::div_euclid(&-x, &y) * y + Euclid::rem_euclid(&-x, &y) + x
                        <= 46.4 * <$t as crate::num_bigint::float::FloatCore>::epsilon());
