...
pub use crate::elliptic_curve::ecdh::diffie_hellman;

use crate::p256::NistP256;

/// NIST P-256 Ephemeral Diffie-Hellman Secret.
pub type EphemeralSecret = crate::elliptic_curve::ecdh::EphemeralSecret<NistP256>;

/// Shared secret value computed via ECDH key agreement.
pub type SharedSecret = crate::elliptic_curve::ecdh::SharedSecret<NistP256>;
