...
impl crate::elliptic_curve::Curve for NistP256 {
...
impl crate::elliptic_curve::PrimeCurve for NistP256 {}

impl crate::elliptic_curve::point::PointCompression for NistP256 {
    /// NIST P-256 points are typically uncompressed.
    const COMPRESS_POINTS: bool = false;
}

impl crate::elliptic_curve::point::PointCompaction for NistP256 {
    /// NIST P-256 points are typically uncompressed.
...
/// Blinded scalar.
#[cfg(feature = "p256_arithmetic")]
pub type BlindedScalar = crate::elliptic_curve::scalar::BlindedScalar<NistP256>;

/// Compressed SEC1-encoded NIST P-256 curve point.
pub type CompressedPoint = GenericArray<u8, U33>;

/// NIST P-256 SEC1 encoded point.
pub type EncodedPoint = crate::elliptic_curve::sec1::EncodedPoint<NistP256>;

/// NIST P-256 field element serialized as bytes.
///
/// Byte array containing a serialized field element value (base field or scalar).
pub type FieldBytes = crate::elliptic_curve::FieldBytes<NistP256>;
...
#[cfg(feature = "p256_arithmetic")]
pub type NonZeroScalar = crate::elliptic_curve::NonZeroScalar<NistP256>;

/// NIST P-256 public key.
#[cfg(feature = "p256_arithmetic")]
pub type PublicKey = crate::elliptic_curve::PublicKey<NistP256>;

/// NIST P-256 secret key.
pub type SecretKey = crate::elliptic_curve::SecretKey<NistP256>;
