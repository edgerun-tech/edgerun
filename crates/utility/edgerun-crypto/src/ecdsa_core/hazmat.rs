...
use crate::elliptic_curve::{FieldBytesEncoding, ScalarPrimitive};

#[cfg(any(feature = "p256_ecdsa_arithmetic", feature = "p256_ecdsa_digest"))]
use crate::{ecdsa_core::Signature, elliptic_curve::generic_array::ArrayLength};
    ...
    SignatureSize<C>: ArrayLength<u8>,
{
    ...
    {
        let k = Scalar::<C>::from_repr(crate::ecdsa_core::rfc6979::generate_k::<D, _>(
            &self.to_repr(),
...
#[cfg(all(test, feature = "p256_ecdsa_internal_tests"))]
mod tests {
    use super::bits2field;
    use crate::elliptic_curve::dev::MockCurve;
    use crate::hex;
