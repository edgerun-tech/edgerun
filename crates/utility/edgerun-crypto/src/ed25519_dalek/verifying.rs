...
#[cfg(feature = "digest")]
use crate::signature::DigestVerifier;
...
impl Verifier<crate::ed25519::Signature> for VerifyingKey {
...
#[cfg(feature = "digest")]
impl<MsgDigest> DigestVerifier<MsgDigest, crate::ed25519::Signature> for VerifyingKey
where
    MsgDigest: Digest<OutputSize = U64>,
{
    fn verify_digest(
...
#[cfg(feature = "digest")]
impl<MsgDigest> DigestVerifier<MsgDigest, crate::ed25519::Signature>
    for Context<'_, '_, VerifyingKey>
where
    MsgDigest: Digest<OutputSize = U64>,
{
    fn verify_digest(
...
impl crate::pkcs8::EncodePublicKey for VerifyingKey {
    fn to_public_key_der(&self) -> crate::pkcs8::spki::Result<crate::pkcs8::Document> {
        crate::pkcs8::PublicKeyBytes::from(self).to_public_key_der()
    }
}

#[cfg(all(feature = "alloc", feature = "pkcs8"))]
impl crate::pkcs8::spki::DynSignatureAlgorithmIdentifier for VerifyingKey {
    fn signature_algorithm_identifier(
        ...
        Ok(crate::ed25519::pkcs8::spki::AlgorithmIdentifierOwned {
...
#[cfg(feature = "pkcs8")]
impl TryFrom<crate::pkcs8::PublicKeyBytes> for VerifyingKey {
...
#[cfg(feature = "pkcs8")]
impl From<VerifyingKey> for crate::pkcs8::PublicKeyBytes {
    fn from(verifying_key: VerifyingKey) -> crate::pkcs8::PublicKeyBytes {
        crate::pkcs8::PublicKeyBytes::from(&verifying_key)
    }
}
...
impl From<&VerifyingKey> for crate::pkcs8::PublicKeyBytes {
    fn from(verifying_key: &VerifyingKey) -> crate::pkcs8::PublicKeyBytes {
        crate::pkcs8::PublicKeyBytes(verifying_key.to_bytes())
    }
}
