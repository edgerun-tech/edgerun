...
use crate::ed25519_dalek::constants::*;
use crate::ed25519_dalek::errors::*;
...
impl InternalSignature {
    ...
    /// documentation for [`crate::ed25519_dalek::VerifyingKey::verify_strict`].)
    #[inline]
    #[allow(non_snake_case)]
...
impl TryFrom<&crate::ed25519::Signature> for InternalSignature {
    type Error = SignatureError;

    fn try_from(sig: &crate::ed25519::Signature) -> Result<InternalSignature, SignatureError> {
        InternalSignature::from_bytes(&sig.to_bytes())
    }
}

impl From<InternalSignature> for crate::ed25519::Signature {
    fn from(sig: InternalSignature) -> crate::ed25519::Signature {
        crate::ed25519::Signature::from_components(*sig.R.as_bytes(), *sig.s.as_bytes())
    }
}
