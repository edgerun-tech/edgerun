...
#[cfg(feature = "digest")]
use crate::signature::DigestSigner;
...
impl SigningKey {
    ...
    /// [`crate::ed25519_dalek::Sha512`] for user convenience.
    ///
    /// # Examples
    ///
    ...
    /// let sig: Signature = signing_key.sign_prehashed(prehashed, Some(context))?;
    ///
    /// // The crate::sha2::Sha512 struct doesn't implement Copy, so we'll have to create a new one:
...
/// of SHA-512 is NOT specification-compliant. We expose [`crate::ed25519_dalek::Sha512`] for user convenience.
#[cfg(feature = "digest")]
...
impl crate::pkcs8::EncodePrivateKey for SigningKey {
    fn to_pkcs8_der(&self) -> crate::pkcs8::Result<crate::pkcs8::SecretDocument> {
        crate::pkcs8::KeypairBytes::from(self).to_pkcs8_der()
    }
}

#[cfg(all(feature = "alloc", feature = "pkcs8"))]
impl crate::pkcs8::spki::DynSignatureAlgorithmIdentifier for SigningKey {
    fn signature_algorithm_identifier(
        &self,
    ) -> crate::pkcs8::spki::Result<crate::pkcs8::spki::AlgorithmIdentifierOwned> {
        // From https://datatracker.ietf.org/doc/html/rfc8410
        // `id-Ed25519   OBJECT IDENTIFIER ::= { 1 3 101 112 }`
        Ok(crate::pkcs8::spki::AlgorithmIdentifier {
            oid: crate::ed25519::pkcs8::ALGORITHM_OID,
            parameters: None,
        })
    }
}
...
#[cfg(feature = "pkcs8")]
impl TryFrom<crate::pkcs8::KeypairBytes> for SigningKey {
    type Error = crate::pkcs8::Error;

    fn try_from(pkcs8_key: crate::pkcs8::KeypairBytes) -> crate::pkcs8::Result<Self> {
    ...
    fn try_from(pkcs8_key: &crate::pkcs8::KeypairBytes) -> crate::pkcs8::Result<Self> {
        ...
        if let Some(public_bytes) = &pkcs8_key.public_key {
            ...
            if signing_key.verifying_key() != expected_verifying_key {
                return Err(crate::pkcs8::Error::KeyMalformed);
            }
        }
...
#[cfg(feature = "pkcs8")]
impl From<SigningKey> for crate::pkcs8::KeypairBytes {
    fn from(signing_key: SigningKey) -> crate::pkcs8::KeypairBytes {
        crate::pkcs8::KeypairBytes::from(&signing_key)
    }
}
...
#[cfg(feature = "pkcs8")]
impl TryFrom<crate::pkcs8::PrivateKeyInfo<'_>> for SigningKey {
    type Error = crate::pkcs8::Error;

    fn try_from(private_key: crate::pkcs8::PrivateKeyInfo<'_>) -> crate::pkcs8::Result<Self> {
        crate::pkcs8::KeypairBytes::try_from(private_key)?.try_into()
    }
}
