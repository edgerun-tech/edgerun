...
use edgerun_json_compat::de::{self, SeqAccess, Visitor};
use edgerun_json_compat::{Deserialize, Deserializer, Serialize, Serializer, ser::SerializeTuple};
...
mod tests {
    ...
    #[test]
    fn test_serialize() {
        let array = GenericArray::<u8, crate::typenum::U2>::default();
    ...
    #[test]
    fn test_deserialize() {
        let mut array = GenericArray::<u8, crate::typenum::U2>::default();
        array[0] = 1;
        array[1] = 2;
    ...
    fn test_serialized_size() {
        let array = GenericArray::<u8, crate::typenum::U1>::default();
