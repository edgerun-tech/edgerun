...
//! ```no_run
//! use edgerun_http_client::http::{StatusCode};
//! use edgerun_http_client::http::http1::{Handler, into_handler, Request, Response};
//!
...
//! ```no_run
//! use edgerun_http_client::http::{StatusCode};
//! use edgerun_http_client::http::http1::{Handler, into_handler_async, Request, Response};
//!
...
//! ```no_run
//! use edgerun_http_client::http::{StatusCode};
//! use edgerun_http_client::http::http1::{into_handler, Request, Response};
//!
