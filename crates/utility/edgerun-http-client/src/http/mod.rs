...
//! # #[cfg(feature = "server")]
//! # {
//! use edgerun_http_client::http::{HttpServer, Handler, Request, Response, StatusCode};
//!
//! struct HelloHandler;
//!
...
//! }
//!
//! # edgerun_http_client::rt::Runtime::new_multi_thread().enable_all().build().unwrap().block_on(async {
...
//! # #[cfg(feature = "client")]
//! # {
//! use edgerun_http_client::http::HttpClient;
//!
//! # edgerun_http_client::rt::Runtime::new_multi_thread().enable_all().build().unwrap().block_on(async {
