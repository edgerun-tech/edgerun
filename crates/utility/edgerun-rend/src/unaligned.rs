...
mod tests {
    ...
    fn signed_integers() {
        ...
        unsafe {
            ...
            assert_eq!(
                ...
                transmute::<_, [u8; 8]>(i64_ule::from_native(0x0102030405060708)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08],
                transmute::<_, [u8; 8]>(i64_ube::from_native(0x0102030405060708)),
            );
            ...
            assert_eq!(
                ...
                transmute::<_, [u8; 16]>(i128_ule::from_native(0x0102030405060708090a0b0c0d0e0f10)),
            );
            assert_eq!(
                [
                ...
                transmute::<_, [u8; 16]>(i128_ube::from_native(0x0102030405060708090a0b0c0d0e0f10)),
            );
        }
    }
    ...
    fn unsigned_integers() {
        ...
        unsafe {
            ...
            assert_eq!(
                [0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01],
                transmute::<_, [u8; 8]>(u64_ule::from_native(0x0102030405060708)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08],
                transmute::<_, [u8; 8]>(u64_ube::from_native(0x0102030405060708)),
            );
            ...
            assert_eq!(
                ...
                transmute::<_, [u8; 16]>(u128_ule::from_native(0x0102030405060708090a0b0c0d0e0f10)),
            );
            assert_eq!(
                [
                    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
                ...
                transmute::<_, [u8; 16]>(u128_ube::from_native(0x0102030405060708090a0b0c0d0e0f10)),
            );
        }
    }
    ...
    fn floats() {
        ...
        unsafe {
            ...
            assert_eq!(
                [0xdb, 0x0f, 0x49, 0x40],
                transmute::<_, [u8; 4]>(f32_ule::from_native(core::f32::consts::PI)),
            );
            assert_eq!(
                [0x40, 0x49, 0x0f, 0xdb],
                transmute::<_, [u8; 4]>(f32_ube::from_native(core::f32::consts::PI)),
            );

            // f64
            assert_eq!(
                [0x18, 0x2d, 0x44, 0x54, 0xfb, 0x21, 0x09, 0x40],
                transmute::<_, [u8; 8]>(f64_ule::from_native(core::f64::consts::PI)),
            );
            assert_eq!(
                [0x40, 0x09, 0x21, 0xfb, 0x54, 0x44, 0x2d, 0x18],
                transmute::<_, [u8; 8]>(f64_ube::from_native(core::f64::consts::PI)),
            );
    ...
    fn signed_non_zero() {
        ...
        unsafe {
            ...
            assert_eq!(
                [0x04, 0x03, 0x02, 0x01],
                transmute::<_, [u8; 4]>(NonZeroI32_ule::new_unchecked(0x01020304)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04],
                transmute::<_, [u8; 4]>(NonZeroI32_ube::new_unchecked(0x01020304)),
            );

            // NonZeroI64
            assert_eq!(
                [0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01],
                transmute::<_, [u8; 8]>(NonZeroI64_ule::new_unchecked(0x0102030405060708)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08],
                transmute::<_, [u8; 8]>(NonZeroI64_ube::new_unchecked(0x0102030405060708)),
            );
    ...
    fn unsigned_non_zero() {
        ...
        unsafe {
            ...
            assert_eq!(
                [0x04, 0x03, 0x02, 0x01],
                transmute::<_, [u8; 4]>(NonZeroU32_ule::new_unchecked(0x01020304)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04],
                transmute::<_, [u8; 4]>(NonZeroU32_ube::new_unchecked(0x01020304)),
            );

            // NonZeroU64
            assert_eq!(
                [0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01],
                transmute::<_, [u8; 8]>(NonZeroU64_ule::new_unchecked(0x0102030405060708)),
            );
            assert_eq!(
                [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08],
                transmute::<_, [u8; 8]>(NonZeroU64_ube::new_unchecked(0x0102030405060708)),
            );
