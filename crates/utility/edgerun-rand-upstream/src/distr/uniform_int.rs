...
mod tests {
    ...
    fn test_uniform_usize_deserialization() {
        ...
        let serialized = edgerun_json::to_string(&original).expect("serialization");
        let deserialized: UniformUsize =
            edgerun_json::from_serde_str(&serialized).expect("deserialization");
    ...
    fn test_uniform_usize_deserialization_from_32bit() {
        ...
        let deserialized: UniformUsize =
            edgerun_json::from_serde_str(&serialized_on_32bit).expect("deserialization");
        assert_eq!(
            deserialized,
