    ...
    pub const fn from_preset(preset: UiRadiusPreset) -> Self {
        match preset {
            ...
            UiRadiusPreset::Soft => Self {
                control: 14.0,
                card: super::spacing::CARD_RADIUS_MAX,
                panel: 18.0,
                pill: 999.0,
            },
        }
...
mod tests {
    ...
    #[test]
    fn card_radius_presets_do_not_exceed_product_contract() {
        for preset in [
            UiRadiusPreset::None,
            UiRadiusPreset::Compact,
            UiRadiusPreset::Default,
            UiRadiusPreset::Soft,
        ] {
            let radius = UiRadiusScale::from_preset(preset);
            assert!(radius.card <= spacing::CARD_RADIUS_MAX);
        }
    }
}
...
impl UiDensity {
    pub const fn next(self) -> Self {
        match self {
            ...
            Self::Spacious => Self::Comfortable,
        }
    }
...
pub const fn semantic_colors_for_scheme(scheme: UiColorScheme) -> UiSemanticColors {
    match scheme {
        ...
        UiColorScheme::Terminal => UiSemanticColors {
            bg: palette::BLACK,
            sidebar: palette::BLACK.with_alpha(0.98),
            topbar: palette::SLATE_950.with_alpha(0.96),
            panel: palette::SLATE_950.with_alpha(0.94),
            row: palette::SLATE_900.with_alpha(0.78),
            active: palette::ACTIVE_ROW,
            composer: palette::SLATE_950.with_alpha(0.98),
            text: palette::SLATE_50,
            muted: palette::SLATE_400,
            border: palette::EMERALD_500.with_alpha(0.34),
        ...
        UiColorScheme::Light => UiSemanticColors {
            bg: palette::SLATE_50,
            sidebar: palette::SLATE_50.with_alpha(0.98),
            topbar: palette::SLATE_50.with_alpha(0.96),
            panel: palette::SLATE_50.with_alpha(0.94),
            row: palette::SLATE_400.with_alpha(0.22),
            active: palette::ACTIVE_ROW,
            composer: palette::SLATE_50.with_alpha(0.98),
            text: palette::SLATE_950,
            muted: palette::SLATE_700,
            border: palette::SLATE_400.with_alpha(0.52),
            accent: palette::ACCENT,
            accent_text: palette::ACCENT_TEXT,
            success: palette::GREEN,
            warning: palette::AMBER,
...
pub const fn accent_color(accent: UiAccentPreset) -> Color4 {
    match accent {
        ...
        UiAccentPreset::Blue => palette::CYAN_600,
...
impl UiComponentPreviewState {
    ...
    pub const fn resolved_theme(self) -> UiResolvedTheme {
        let mut theme = UiResolvedTheme::from_preset(self.authority, self.active_preset());
