...
fn print_usage() {
    ...
    eprintln!(
        "  deployment  Deployment operations (create, get, address, escrow-authority, assign, start, pause, resume, dispute, resolve, stop, tick-burn, report, burn-rate, schedule-pricing)"
    );
