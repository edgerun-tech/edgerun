...
impl Keymap {
    ...
    pub fn estonian_nodeadkeys() -> Self {
        ...
        special[scancode::KEY_BACKSPACE as usize] =
            Some((SpecialKey::Backspace, SpecialKey::Backspace));
        special[scancode::KEY_CAPSLOCK as usize] =
            Some((SpecialKey::CapsLock, SpecialKey::CapsLock));
        special[scancode::KEY_LEFTSHIFT as usize] =
            Some((SpecialKey::ShiftLeft, SpecialKey::ShiftLeft));
        special[scancode::KEY_RIGHTSHIFT as usize] =
            Some((SpecialKey::ShiftRight, SpecialKey::ShiftRight));
        special[scancode::KEY_LEFTCTRL as usize] =
            Some((SpecialKey::CtrlLeft, SpecialKey::CtrlLeft));
        special[scancode::KEY_RIGHTCTRL as usize] =
            Some((SpecialKey::CtrlRight, SpecialKey::CtrlRight));
        special[scancode::KEY_LEFTALT as usize] = Some((SpecialKey::AltLeft, SpecialKey::AltLeft));
        special[scancode::KEY_RIGHTALT as usize] =
            Some((SpecialKey::AltRight, SpecialKey::AltRight));
        ...
        special[scancode::KEY_PAGEDOWN as usize] =
            Some((SpecialKey::PageDown, SpecialKey::PageDown));
