...
pub mod constraints_request {
    ...
    pub const LOCK_POINTER_SIG: &[ArgType] = &[ArgType::NewId, ArgType::Object, ArgType::Object, ArgType::Uint, ArgType::Uint];
    // id: new_id, surface: object, pointer: object, lifetime: uint, region: object(nullable)

    pub const CONFINE_POINTER: u16 = 2;
    pub const CONFINE_POINTER_SIG: &[ArgType] = &[ArgType::NewId, ArgType::Object, ArgType::Object, ArgType::Uint, ArgType::Uint];
    // id: new_id, surface: object, pointer: object, lifetime: uint, region: object(nullable)
}
