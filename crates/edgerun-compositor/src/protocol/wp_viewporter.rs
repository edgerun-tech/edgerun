...
pub mod viewporter_request {
    ...
    pub const GET_VIEWPORT_SIG: &[ArgType] = &[ArgType::NewId, ArgType::Object]; // viewport, surface
}
...
pub mod viewport_request {
    ...
    pub const SET_SOURCE_SIG: &[ArgType] = &[ArgType::Fixed, ArgType::Fixed, ArgType::Fixed, ArgType::Fixed];
