...
pub mod pointer_gestures_request {
    ...
    pub const GET_PINCH_GESTURE_SIG: &[ArgType] = &[ArgType::Object, ArgType::NewId]; // wl_pointer, zwp_gesture_pinch_v1
}
