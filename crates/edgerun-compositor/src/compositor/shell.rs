...
impl Shell {
    ...
    pub fn configure_toplevel(&mut self, toplevel_id: u32, _width: i32, _height: i32) -> u32 {
    ...
    pub fn set_pending_token_app_id(&mut self, token_id: u32, app_id: &str) {
        self.pending_token_app_id
            .insert(token_id, app_id.to_string());
    }
