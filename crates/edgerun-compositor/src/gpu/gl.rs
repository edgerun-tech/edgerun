...
pub type PFNGLTEXIMAGE2DPROC = unsafe extern "system" fn(
    ...
    format: GLenum, ty: GLenum, pixels: *const GLvoid,
);
...
pub type PFNGLCLEARCOLORPROC = unsafe extern "system" fn(r: GLfloat, g: GLfloat, b: GLfloat, a: GLfloat);
...
pub type PFNGLDRAWELEMENTSPROC = unsafe extern "system" fn(mode: GLenum, count: GLsizei, ty: GLenum, indices: *const GLvoid);
...
pub type PFNGLREADPIXELSPROC = unsafe extern "system" fn(
    ...
    format: GLenum, ty: GLenum, pixels: *mut GLvoid,
);

// OpenGL 2.0+ (for shaders)
pub type PFNGLCREATESHADERPROC = unsafe extern "system" fn(shaderType: GLenum) -> GLuint;
pub type PFNGLSHADERSOURCEPROC = unsafe extern "system" fn(shader: GLuint, count: GLsizei, string: *const *const c_char, length: *const GLint);
...
pub type PFNGLGETSHADERINFOLOGPROC = unsafe extern "system" fn(shader: GLuint, bufSize: GLsizei, length: *mut GLsizei, infoLog: *mut c_char);
...
pub type PFNGLGETPROGRAMINFOLOGPROC = unsafe extern "system" fn(program: GLuint, bufSize: GLsizei, length: *mut GLsizei, infoLog: *mut c_char);
pub type PFNGLUSEPROGRAMPROC = unsafe extern "system" fn(program: GLuint);
pub type PFNGLGETATTRIBLOCATIONPROC = unsafe extern "system" fn(program: GLuint, name: *const c_char) -> GLint;
pub type PFNGLGETUNIFORMLOCATIONPROC = unsafe extern "system" fn(program: GLuint, name: *const c_char) -> GLint;
...
pub type PFNGLVERTEXATTRIBPOINTERPROC = unsafe extern "system" fn(
    index: GLuint, size: GLint, ty: GLenum, normalized: GLboolean,
...
pub type PFNGLGENFRAMEBUFFERSPROC = unsafe extern "system" fn(n: GLsizei, framebuffers: *mut GLuint);
...
pub type PFNGLDELETEFRAMEBUFFERSPROC = unsafe extern "system" fn(n: GLsizei, framebuffers: *const GLuint);
pub type PFNGLGENRENDERBUFFERSPROC = unsafe extern "system" fn(n: GLsizei, renderbuffers: *mut GLuint);
pub type PFNGLBINDRENDERBUFFERPROC = unsafe extern "system" fn(target: GLenum, renderbuffer: GLuint);
pub type PFNGLRENDERBUFFERSTORAGEPROC = unsafe extern "system" fn(
    target: GLenum, internalformat: GLenum,
...
pub type PFNGLDELETERENDERBUFFERSPROC = unsafe extern "system" fn(n: GLsizei, renderbuffers: *const GLuint);

// GL_OES_EGL_image_external
pub type PFNGLEGLIMAGETARGETTEXTURE2DOESPROC = unsafe extern "system" fn(target: GLenum, image: *mut c_void);
...
pub type PFNGLBUFFERDATAPROC = unsafe extern "system" fn(target: GLenum, size: GLsizeiptr, data: *const GLvoid, usage: GLenum);
