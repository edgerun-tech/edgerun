...
pub fn build_display_list(root: &super::render_object::RenderObject) -> Vec<PaintCommand> {
    let mut cmds = Vec::new();
    build_inner(root, &mut cmds);
    cmds
}

fn build_inner(obj: &super::render_object::RenderObject, out: &mut Vec<PaintCommand>) {
    match obj {
        super::render_object::RenderObject::BlockContainer { children, style }
        | super::render_object::RenderObject::FlexContainer { children, style }
        | super::render_object::RenderObject::GridContainer { children, style }
        | super::render_object::RenderObject::InlineContainer { children, style } => {
