...
export class WebGLRenderer {
  ...
  render(input: RenderInput) {
    ...
    for (const [id, node] of nodes) {
      ...
      this.colors[ni * 4 + 3] = color[3]
      this.sizes[ni] = getNodeSize(0, isHighlighted, isSelected, runtime, runtimeMode)
    ...
    if (nodeCount > 0) {
      ...
      gl.bufferData(gl.ARRAY_BUFFER, this.positions.subarray(0, nodeCount * 2), gl.DYNAMIC_DRAW)
      ...
      gl.bufferData(gl.ARRAY_BUFFER, this.colors.subarray(0, nodeCount * 4), gl.DYNAMIC_DRAW)
      ...
      gl.bufferData(gl.ARRAY_BUFFER, this.sizes.subarray(0, nodeCount), gl.DYNAMIC_DRAW)
      ...
      gl.bufferData(gl.ARRAY_BUFFER, this.sels.subarray(0, nodeCount), gl.DYNAMIC_DRAW)
