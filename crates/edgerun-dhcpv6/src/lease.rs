...
impl Dhcpv6Lease {
    ...
    pub fn preferred_remaining(&self) -> u32 {
        let elapsed = self.granted_at.elapsed().as_secs() as u32;
    ...
    pub fn is_renewal_due(&self) -> bool {
        self.granted_at.elapsed() > Duration::from_secs(self.preferred_lifetime as u64)
    }

    /// Returns true if valid lifetime has expired.
    pub fn is_expired(&self) -> bool {
        self.granted_at.elapsed() > Duration::from_secs(self.valid_lifetime as u64)
    }
}
