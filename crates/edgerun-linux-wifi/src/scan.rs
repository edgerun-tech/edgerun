...
pub fn nl80211_scan(ifindex: i32, ssids: Option<&[&[u8]]>, flush: bool, frequencies: Option<&[u32]>) -> Result<Vec<WifiNetworkObservation>, CapabilityError> {
...
pub fn parse_scan_results(data: &[u8]) -> Result<Vec<WifiNetworkObservation>, CapabilityError> {
...
pub fn parse_bss_info(data: &[u8], attr_start: usize, msg_end: usize) -> Option<WifiNetworkObservation> {
