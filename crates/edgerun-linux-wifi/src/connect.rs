...
pub fn nl80211_disconnect(ifindex: i32) -> Result<(), CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
...
pub fn nl80211_set_interface_type(ifindex: i32, iftype: u32) -> Result<(), CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
...
pub fn nl80211_get_interface_type(ifindex: i32) -> Result<u32, CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
...
pub fn nl80211_get_station(ifindex: i32, bssid: &[u8; 6]) -> Result<(Option<i32>, Option<u32>), CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
...
pub fn nl80211_dump_stations(ifindex: i32) -> Result<Vec<([u8; 6], i32, Option<u32>)>, CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
