...
pub fn nl80211_stop_ap(ifindex: i32) -> Result<(), CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
...
pub fn nl80211_set_wiphy_freq(ifindex: i32, freq_mhz: u32) -> Result<(), CapabilityError> {
    let mut sock = Nl80211Socket::open()?;
