//! HTTP/2 frame protocol implementation
...
mod tests {
    ...
    fn test_goaway_frame_roundtrip() {
        let goaway = GoawayFrame::new(5, 0, b"debug info".to_vec());
