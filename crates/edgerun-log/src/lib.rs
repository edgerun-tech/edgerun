...
#[macro_export]
macro_rules! trace { ($($tt:tt)*) => { $crate::__log!($crate::Level::Trace, $($tt)*) }; }
#[macro_export]
macro_rules! debug { ($($tt:tt)*) => { $crate::__log!($crate::Level::Debug, $($tt)*) }; }
#[macro_export]
macro_rules! info  { ($($tt:tt)*) => { $crate::__log!($crate::Level::Info, $($tt)*) }; }
#[macro_export]
macro_rules! warn  { ($($tt:tt)*) => { $crate::__log!($crate::Level::Warn, $($tt)*) }; }
#[macro_export]
macro_rules! error { ($($tt:tt)*) => { $crate::__log!($crate::Level::Error, $($tt)*) }; }
