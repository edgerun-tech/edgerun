;; ═════════════════════════════════════════════════════════════════════
  ...
  (func $template_i32_rotl (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  ...
  (func $template_i64_rotl (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  ...
  (func $template_i32_trunc_f32_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_f32_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_f64_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_f64_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_sat_f32_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_sat_f32_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_sat_f64_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i32_trunc_sat_f64_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i64_trunc_f32_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i64_trunc_f32_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i64_trunc_f64_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i64_trunc_f64_u (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
  (func $template_i64_trunc_sat_f32_s (param $dec_ptr i32) (global.set $JIT_ERROR (i32.const -4)))
