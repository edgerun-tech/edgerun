;; ═════════════════════════════════════════════════════════════════════
  ...
  ;;
  ;; This is a GENERATOR TEMPLATE. Placeholders ({SUFFIX}, {OP_TABLE},
  ;; {FC_TABLE}, {FD_TABLE}) are expanded by tools/gen_compiler.py
  ...
  ;; The opcode dispatch tables {OP_TABLE}, {FC_TABLE}, {FD_TABLE}
