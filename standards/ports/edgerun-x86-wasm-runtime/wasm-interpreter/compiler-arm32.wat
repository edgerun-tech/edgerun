  ...
  (func $jit_compile (export "jit_compile") (param $func_idx i32) (result i32)
    ...
    (block $compile_done
      (loop $compile_loop
        ...
        ;; Read next opcode for peephole (at dec_ptr + 16)
        (if (i32.load (i32.add (local.get $dec_ptr) (i32.const 16)))
          (then
            (global.set $NEXT_OP (i32.load (i32.add (local.get $dec_ptr) (i32.const 16))))
          )
          (else
