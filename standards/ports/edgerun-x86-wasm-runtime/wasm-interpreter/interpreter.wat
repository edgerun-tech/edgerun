    ...
    (block $dispatch_end
      (loop $dispatch_loop
        ...
        (block $op_done
          ...
          ;; ═════════════════════════════════════════════
          ;; call_indirect (0x11) - call via table dispatch
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; f32.load (0x2A) - load 4 bytes, reinterpret as f32 bits on stack
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; f64.load (0x2B) - load 8 bytes, reinterpret as f64 bits on stack
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; f32.store (0x38) - store 4 bytes (f32 bit pattern)
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; f64.store (0x39) - store 8 bytes (f64 bit pattern)
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; table.get (0x25) - get table entry
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; table.set (0x26) - set table entry
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; i64.eqz (0x50) - pop i64, push i32 0/1
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; f32 comparison ops (0x5B-0x60) - use scratch1/scratch0 for operands
          ;; ═════════════════════════════════════════════
          ;; f32.eq (0x5B)
          ...
          ;; ═════════════════════════════════════════════
          ;; f64 comparison ops (0x61-0x66) - stored as two i32 slots
          ;; ═════════════════════════════════════════════
          ;; f64.eq (0x61)
          ...
          ;; ═════════════════════════════════════════════
          ;; i32.wrap_i64 (0xA7) - wrap i64 to i32
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; i64.extend_i32_s (0xAC) - sign-extend i32 to i64
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; i64.extend_i32_u (0xAD) - zero-extend i32 to i64
          ;; ═════════════════════════════════════════════
          ...
          ;; ═════════════════════════════════════════════
          ;; i64 unary ops (0x79-0x7B) - pop i64, push i64
          ;; ═════════════════════════════════════════════
          ;; i64.clz (0x79)
          (if (i32.eq (local.get $op) (i32.const 0x79))
            (then
              (local.set $err (call $stack_pop_i64))
              (if (local.get $err) (then (return (local.get $err))))
              (local.set $tmp64 (i64.or (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH0))) (i64.shl (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH1))) (i64.const 32))))
          ...
          ;; i64.popcnt (0x7B)
          (if (i32.eq (local.get $op) (i32.const 0x7B))
            (then
              (local.set $err (call $stack_pop_i64))
              (if (local.get $err) (then (return (local.get $err))))
              (local.set $tmp64 (i64.or (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH0))) (i64.shl (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH1))) (i64.const 32))))
          ...
          ;; ═════════════════════════════════════════════
          ;; f32 binary ops (0x92-0x98) - use scratch1/scratch0 for operands
          ;; ═════════════════════════════════════════════
          ;; f32.add (0x92)
          ...
          ;; ═════════════════════════════════════════════
          ;; f64 unary ops (0x99-0x9F) - stored as two i32 slots (lo, hi)
          ;; ═════════════════════════════════════════════
          ;; f64.abs (0x99)
          ...
          ;; ═════════════════════════════════════════════
          ;; f64 ops (0xA0-0xBB) - bit-preserving via i64 reinterpret
          ;; ═════════════════════════════════════════════
          ;; f64 binary: pop both operands into tmp64/tmp64b
          ;; f64.add (0xA0)
          ...
          ;; ═════════════════════════════════════════════
          ;; float↔int conversion ops (0xA8-0xBB)
          ;; ═════════════════════════════════════════════
          ...
          (if (i32.eq (local.get $op) (i32.const 0xB9))
            (then
              (local.set $err (call $stack_pop_i64))
              (if (local.get $err) (then (return (local.get $err))))
              (local.set $tmp64 (i64.or (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH0))) (i64.shl (i64.extend_i32_u (i32.load (global.get $OFF_SCRATCH1))) (i64.const 32))))
          ...
          ;; f32.reinterpret_i32 (0xBE) - no-op, bit pattern already on stack
          ...
          ;; f64.reinterpret_i64 (0xBF) - no-op, bit pattern already on stack
          ...
          ;; ── 0xFC prefixed ops (bulk memory, saturating trunc) ──
          (if (i32.eq (local.get $op) (i32.const 0xFC))
            (then
              ;; imm0 = sub-opcode
