(module
  ...
  (import "ui" "command_set_meta_at" (func $command_set_meta_at (param i32) (param i32) (param i32)))
  (import "ui" "command_set_owner_at" (func $command_set_owner_at (param i32) (param i32) (param i32) (param i32) (param i32)))
  (import "ui" "emit_icon_or_rect" (func $emit_icon_or_rect (param i32) (param i32) (param i32) (param f32) (param f32) (param f32) (param f32) (param i32) (param i32) (result i32)))
  ...
  (import "ui" "emit_text" (func $emit_text (param i32) (param i32) (param i32) (param f32) (param f32) (param f32) (param f32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "load16" (func $load16 (param i32) (result i32)))
  (import "ui" "max_f32" (func $max_f32 (param f32) (param f32) (result f32)))
  (import "ui" "packed_second_ref_valid" (func $packed_second_ref_valid (param i32) (param i32) (result i32)))
  (import "ui" "preferred_h" (func $preferred_h (param i32) (result f32)))
  (import "ui" "preferred_w" (func $preferred_w (param i32) (param i32) (result f32)))
  (import "ui" "record_encoded_mul" (func $record_encoded_mul (param i32) (result i32)))
  (import "ui" "record_encoded_state" (func $record_encoded_state (param i32) (param i32) (result i32)))
  ...
  (import "ui" "string_len" (func $string_len (param i32) (result i32)))
  (import "ui" "string_ptr" (func $string_ptr (param i32) (param i32) (param i32) (result i32)))
  ...
  (func $record_at (export "record_at") (param $base i32) (param $index i32) (result i32)
    local.get $base
    i32.const 20
    i32.add
    local.get $index
