(module
  ...
  (import "ui" "cos_rad" (func $cos_rad (param f32) (result f32)))
  (import "ui" "er_ui_icon_ir_byte_len" (func $er_ui_icon_ir_byte_len (param i32) (result i32)))
  (import "ui" "er_ui_icon_ir_ptr" (func $er_ui_icon_ir_ptr (param i32) (result i32)))
  (import "ui" "er_ui_icon_stroke_width" (func $er_ui_icon_stroke_width (param i32) (result f32)))
  (import "ui" "er_ui_icon_valid" (func $er_ui_icon_valid (param i32) (result i32)))
  (import "ui" "icon_pack_entry_valid" (func $icon_pack_entry_valid (param i32) (result i32)))
  ...
  (import "ui" "sin_rad" (func $sin_rad (param f32) (result f32)))
