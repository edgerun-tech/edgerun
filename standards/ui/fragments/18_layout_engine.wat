(module
  ...
  (import "ui" "er_ui_text_longest_utf8_run" (func $er_ui_text_longest_utf8_run (param i32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_utf8_codepoint_count" (func $er_ui_utf8_codepoint_count (param i32) (param i32) (result i32)))
  (import "ui" "finite_f32" (func $finite_f32 (param f32) (result i32)))
  ...
  (func $layout_max_i32_u (export "layout_max_i32_u") (param $a i32) (param $b i32) (result i32)
    local.get $a
    local.get $b
    i32.gt_u
    if (result i32)
  ...
  (func $layout_store_size (export "layout_store_size") (param $out i32) (param $w f32) (param $h f32) (result i32)
    local.get $out
    i32.eqz
    if
      i32.const 0
  ...
  (func $er_ui_centered_square_bounds (export "er_ui_centered_square_bounds") (param $bounds i32) (param $max_size f32) (param $out i32) (result i32)
    (local $size f32)
    local.get $bounds i32.eqz local.get $out i32.eqz i32.or
    if i32.const 0 return end
    local.get $max_size
