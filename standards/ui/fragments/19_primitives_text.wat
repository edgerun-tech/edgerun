(module
  ...
  (import "ui" "er_ui_layout_measure_text" (func $er_ui_layout_measure_text (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_layout_text_metrics_init" (func $er_ui_layout_text_metrics_init (param i32) (param f32) (param f32) (param i32) (result i32)))
  ...
  (func $primitives_average_width (export "primitives_average_width") (param $text_ptr i32) (param $text_len i32) (param $line_height f32) (result f32)
    (local $count i32)
    local.get $text_len
    i32.eqz
    if
  ...
  (func $primitives_text_measure (export "primitives_text_measure") (param $text_ptr i32) (param $text_len i32) (param $constraints i32) (param $line_height f32) (param $max_lines i32) (param $out i32) (result i32)
    i32.const 120256
    local.get $line_height
    local.get $text_ptr
    local.get $text_len
  ...
  (func $textarea_line_start_at (export "textarea_line_start_at") (param $ptr i32) (param $len i32) (param $target_line i32) (result i32)
  ...
  (func $textarea_line_end_at (export "textarea_line_end_at") (param $ptr i32) (param $len i32) (param $start i32) (result i32)
    (local $index i32)
  ...
  (func $er_ui_measure_intrinsic (export "er_ui_measure_intrinsic") (param $w f32) (param $h f32) (param $constraints i32) (param $out i32) (result i32)
    local.get $constraints i32.eqz local.get $out i32.eqz i32.or
    if i32.const 0 return end
  ...
  (func $er_ui_measure_flexible_line (export "er_ui_measure_flexible_line") (param $min_w f32) (param $height f32) (param $constraints i32) (param $out i32) (result i32)
