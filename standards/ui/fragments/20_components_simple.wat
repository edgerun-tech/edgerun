(module
  ...
  (import "ui" "er_ui_centered_square_bounds" (func $er_ui_centered_square_bounds (param i32) (param f32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_layout_measurement_fixed" (func $er_ui_layout_measurement_fixed (param f32) (param f32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_measure_flexible_line" (func $er_ui_measure_flexible_line (param f32) (param f32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_measure_intrinsic" (func $er_ui_measure_intrinsic (param f32) (param f32) (param i32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_tabs_measure_two_segments" (func $er_ui_tabs_measure_two_segments (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  ...
  (import "ui" "er_ui_toggle_text_bounds" (func $er_ui_toggle_text_bounds (param i32) (param i32) (result i32)))
  ...
  (import "ui" "textarea_line_end_at" (func $textarea_line_end_at (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "textarea_line_start_at" (func $textarea_line_start_at (param i32) (param i32) (param i32) (result i32)))
