(module
  ...
  (import "ui" "er_ui_alert_measured_text_height" (func $er_ui_alert_measured_text_height (param i32) (param i32) (param f32) (param f32) (param i32) (result f32)))
  ...
  (import "ui" "er_ui_primitives_measure_side_panel_menu" (func $er_ui_primitives_measure_side_panel_menu (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param f32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_measure_title_detail_panel" (func $er_ui_primitives_measure_title_detail_panel (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_measure_two_item_menu_panel" (func $er_ui_primitives_measure_two_item_menu_panel (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_measured_label_width" (func $er_ui_primitives_measured_label_width (param i32) (param i32) (param f32) (param i32) (param f32) (result f32)))
  (import "ui" "er_ui_primitives_menu_item_bounds" (func $er_ui_primitives_menu_item_bounds (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_menu_list_layout" (func $er_ui_primitives_menu_list_layout (param i32) (param f32) (param f32) (param f32) (param f32) (param f32) (param f32) (result i32)))
  (import "ui" "er_ui_primitives_overlay_indexed_id" (func $er_ui_primitives_overlay_indexed_id (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_overlay_secondary_id" (func $er_ui_primitives_overlay_secondary_id (param i32) (result i32) local.get i32.const 2 i32.add)))
  (import "ui" "er_ui_primitives_overlay_trigger_id" (func $er_ui_primitives_overlay_trigger_id (param i32) (result i32) local.get )))
  (import "ui" "er_ui_primitives_side_panel_content_bounds" (func $er_ui_primitives_side_panel_content_bounds (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_side_panel_layout" (func $er_ui_primitives_side_panel_layout (param i32) (param f32) (param f32) (param f32) (param f32) (result i32)))
  (import "ui" "er_ui_primitives_side_panel_trigger_bounds" (func $er_ui_primitives_side_panel_trigger_bounds (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_primitives_title_detail_panel" (func $er_ui_primitives_title_detail_panel (param i32) (param f32) (param f32) (param f32) (param f32) (param f32) (param f32) (param f32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_rect_with_height_centered" (func $er_ui_rect_with_height_centered (param i32) (param i32) (param f32) (result i32)))
  ...
  (import "ui" "primitives_text_measure" (func $primitives_text_measure (param i32) (param i32) (param i32) (param f32) (param i32) (param i32) (result i32)))
