(module
  ...
  (import "ui" "emit_rect" (func $emit_rect (param i32) (param i32) (param i32) (param f32) (param f32) (param f32) (param f32) (param i32) (result i32)))
  (import "ui" "er_ui_font_text_width" (func $er_ui_font_text_width (param i32) (param i32) (param f32) (result f32)))
  (import "ui" "er_ui_icon_path_len" (func $er_ui_icon_path_len (param i32) (result i32)))
  (import "ui" "er_ui_icon_path_ptr" (func $er_ui_icon_path_ptr (param i32) (result i32)))
  (import "ui" "er_ui_icon_valid" (func $er_ui_icon_valid (param i32) (result i32)))
  (import "ui" "er_ui_record_id" (func $er_ui_record_id (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_record_kind" (func $er_ui_record_kind (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_record_set_id" (func $er_ui_record_set_id (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_record_set_second_ref" (func $er_ui_record_set_second_ref (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_validate" (func $er_ui_validate (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_validate_deep" (func $er_ui_validate_deep (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_writer_begin" (func $er_ui_writer_begin (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_writer_record" (func $er_ui_writer_record (param i32) (param i32) (param i32) (param i32) (param i32) (result i32)))
  (import "ui" "er_ui_writer_string" (func $er_ui_writer_string (param i32) (param i32) (result i32)))
  ...
  (import "ui" "record_at" (func $record_at (param i32) (param i32) (result i32)))
  (import "ui" "rect_store" (func $rect_store (param i32) (param f32) (param f32) (param f32) (param f32) (result i32)))
  (import "ui" "second_ref_is_packed" (func $second_ref_is_packed (param i32) (result i32)))
  (import "ui" "snap_pixel" (func $snap_pixel (param f32) (param f32) (result f32)))
  (import "ui" "store16" (func $store16 (param i32) (param i32)))
  (import "ui" "store32" (func $store32 (param i32) (param i32)))
  (import "ui" "string_ref" (func $string_ref (param i32) (param i32) (result i32)))
  (import "ui" "valid_rect" (func $valid_rect (param f32) (param f32) (result i32)))
