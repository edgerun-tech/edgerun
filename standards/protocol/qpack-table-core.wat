  (import "math" "prefix_mask" (func $m155prefix_mask (param i32) (result i32)))
...
(func (export "proto_standard_id") (result i32)
  ...
  (func $m155qpack_prefix_decode
    ...
    (local.set $mask (call $m155prefix_mask (local.get $prefix_bits)))
