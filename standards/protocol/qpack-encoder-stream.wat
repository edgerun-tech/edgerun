  (import "math" "prefix_mask" (func $m153prefix_mask (param i32) (result i32)))
...
(func (export "proto_standard_id") (result i32)
  ...
  (func $m153qpack_prefix_decode
    ...
    (local.set $mask (call $m153prefix_mask (local.get $prefix_bits)))
  ...
  (func $m153clear_record (param $out_ptr i32)
  ...
  (func $m153copy_name_meta (param $out_ptr i32) (param $base_offset i32) (param $meta_ptr i32)
    (i32.store
  ...
  (func $m153copy_value_meta (param $out_ptr i32) (param $base_offset i32) (param $meta_ptr i32)
    (i32.store
