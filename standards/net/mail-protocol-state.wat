(func $mail_pack_status (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    local.get $a)
  ...
  (func (export "imap_session_transition")
    ...
    (result i32)
    (if (i32.eq (local.get $cmd) (i32.const 0)) (then (return (call $mail_pack_status (i32.const 2) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 1)) (i32.eq (local.get $cmd) (i32.const 2)))
      (then (return (call $mail_pack_status (i32.const 0) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 3))
      (then (return (call $mail_pack_status (i32.const 0) (i32.const 3) (i32.const 0) (i32.const 1)))))
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 4)) (i32.eq (local.get $cmd) (i32.const 5)))
      (then (return (call $mail_pack_status (i32.const 2) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 6))
      (then
        (if (i32.eq (local.get $state) (i32.const 0))
          (then (return (call $mail_pack_status (i32.const 1) (local.get $state) (i32.const 0) (i32.const 0))))
          (else (return (call $mail_pack_status (i32.const 1) (local.get $state) (i32.const 0) (i32.const 0)))))))
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 7)) (i32.eq (local.get $cmd) (i32.const 8)))
      (then
        (if (i32.and (i32.eq (local.get $state) (i32.const 1)) (local.get $mailbox_valid))
          (then (return (call $mail_pack_status (i32.const 0) (i32.const 2) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 1) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 19)) (i32.eq (local.get $cmd) (i32.const 29)))
      (then
        (if (i32.eq (local.get $state) (i32.const 2))
          (then (return (call $mail_pack_status (i32.const 0) (i32.const 1) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 1) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if
      (i32.or
    ...
    (if (i32.eq (local.get $state) (i32.const 0))
      (then (return (call $mail_pack_status (i32.const 1) (local.get $state) (i32.const 0) (i32.const 0)))))
    (call $mail_pack_status (i32.const 0) (local.get $state) (i32.const 0) (i32.const 0)))
  ...
  (func (export "smtp_session_transition")
    ...
    (result i32)
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 1)) (i32.eq (local.get $cmd) (i32.const 2)))
      (then (return (call $mail_pack_status (i32.const 250) (i32.const 1) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 3))
      (then
        (if (i32.eqz (i32.or (i32.eq (local.get $state) (i32.const 1)) (i32.eq (local.get $state) (i32.const 2))))
          (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (if (i32.and (local.get $require_auth) (i32.eqz (local.get $authenticated)))
          (then (return (call $mail_pack_status (i32.const 578) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (i32.const 2) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 4))
      (then
        (if (i32.eqz (i32.or (i32.eq (local.get $state) (i32.const 2)) (i32.eq (local.get $state) (i32.const 3))))
          (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (i32.const 3) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 5))
      (then
        (if (i32.ne (local.get $state) (i32.const 3))
          (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 354) (i32.const 4) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 6))
      (then
        (if (i32.eqz (i32.or (i32.eq (local.get $state) (i32.const 3)) (i32.eq (local.get $state) (i32.const 4))))
          (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (i32.const 4) (i32.const 0) (i32.const 3)))))
    (if (i32.eq (local.get $cmd) (i32.const 7)) (then (return (call $mail_pack_status (i32.const 250) (i32.const 1) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 8)) (then (return (call $mail_pack_status (i32.const 250) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 9)) (then (return (call $mail_pack_status (i32.const 221) (i32.const 5) (i32.const 0) (i32.const 1)))))
    (if (i32.eq (local.get $cmd) (i32.const 10))
      (then
        (if (local.get $tls_active) (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (if (i32.eqz (local.get $starttls_available)) (then (return (call $mail_pack_status (i32.const 551) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (local.get $state) (i32.const 0) (i32.const 2)))))
    (if (i32.or (i32.eq (local.get $cmd) (i32.const 11)) (i32.or (i32.eq (local.get $cmd) (i32.const 12)) (i32.eq (local.get $cmd) (i32.const 15))))
      (then (return (call $mail_pack_status (i32.const 551) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 13)) (then (return (call $mail_pack_status (i32.const 211) (local.get $state) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 16)) (then (return (call $mail_pack_status (i32.const 250) (local.get $state) (i32.const 0) (i32.const 0)))))
        ...
        (if (i32.eq (local.get $auth_mech) (i32.const 1))
          (then
            (if (local.get $auth_initial)
              (then (return (call $mail_pack_status (i32.const 250) (local.get $state) (i32.const 0) (i32.const 0))))
              (else (return (call $mail_pack_status (i32.const 334) (local.get $state) (i32.const 1) (i32.const 0)))))))
        (if (i32.eq (local.get $auth_mech) (i32.const 2))
          (then (return (call $mail_pack_status (i32.const 334) (local.get $state) (i32.const 2) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 578) (local.get $state) (i32.const 0) (i32.const 0)))))
    (call $mail_pack_status (i32.const 554) (local.get $state) (i32.const 0) (i32.const 0)))
  ...
  (func (export "smtp_auth_exchange_transition")
    ...
    (if (i32.eq (local.get $exchange) (i32.const 0))
      (then (return (call $mail_pack_status (i32.const 554) (i32.const 0) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $exchange) (i32.const 2))
      (then (return (call $mail_pack_status (i32.const 334) (i32.const 0) (i32.const 3) (i32.const 0)))))
    (if (i32.eq (local.get $result) (i32.const 0))
      (then (return (call $mail_pack_status (i32.const 250) (i32.const 0) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $result) (i32.const 1))
      (then (return (call $mail_pack_status (i32.const 578) (i32.const 0) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $result) (i32.const 2))
      (then (return (call $mail_pack_status (i32.const 578) (i32.const 0) (i32.const 0) (i32.const 0)))))
    (call $mail_pack_status (i32.const 554) (i32.const 0) (i32.const 0) (i32.const 0)))
  ...
  (func (export "lmtp_session_transition") (param $state i32) (param $cmd i32) (param $recipient_valid i32) (result i32)
    (if (i32.eq (local.get $cmd) (i32.const 17)) (then (return (call $mail_pack_status (i32.const 250) (i32.const 1) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 3))
      (then
        (if (i32.eqz (i32.or (i32.eq (local.get $state) (i32.const 1)) (i32.eq (local.get $state) (i32.const 2)))) (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (i32.const 2) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 4))
      (then
        (if (i32.eqz (i32.or (i32.eq (local.get $state) (i32.const 2)) (i32.eq (local.get $state) (i32.const 3)))) (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (if (i32.eqz (local.get $recipient_valid)) (then (return (call $mail_pack_status (i32.const 550) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 250) (i32.const 3) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 5))
      (then
        (if (i32.ne (local.get $state) (i32.const 3)) (then (return (call $mail_pack_status (i32.const 503) (local.get $state) (i32.const 0) (i32.const 0)))))
        (return (call $mail_pack_status (i32.const 354) (i32.const 4) (i32.const 0) (i32.const 0)))))
    (if (i32.eq (local.get $cmd) (i32.const 9)) (then (return (call $mail_pack_status (i32.const 221) (i32.const 5) (i32.const 0) (i32.const 1)))))
    (call $mail_pack_status (i32.const 554) (local.get $state) (i32.const 0) (i32.const 0)))
