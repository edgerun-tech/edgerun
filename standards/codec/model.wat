...
;; ── BSS memory layout ──
  (global $MODEL_VERTEX_X        i32 (i32.const 0x700000))
  (global $MODEL_VERTEX_Y        i32 (i32.const 0x708000))
  (global $MODEL_VERTEX_Z        i32 (i32.const 0x710000))
  (global $MODEL_VERTEX_GROUP    i32 (i32.const 0x718000))
  (global $MODEL_FACE_A          i32 (i32.const 0x720000))
  (global $MODEL_FACE_B          i32 (i32.const 0x728000))
  (global $MODEL_FACE_C          i32 (i32.const 0x730000))
  (global $MODEL_FACE_COLOR      i32 (i32.const 0x738000))

  (global $S_DECODE_VERTEX_WRITE_BASE i32 (i32.const 0x750000))
  (global $S_DECODE_FACE_WRITE_BASE   i32 (i32.const 0x750004))
  (global $S_REGISTRY_NEXT_VERTEX     i32 (i32.const 0x750008))
  (global $S_REGISTRY_NEXT_FACE       i32 (i32.const 0x75000c))
  (global $S_LAST_DECODED_VERTEX_COUNT i32 (i32.const 0x750010))
  (global $S_LAST_DECODED_FACE_COUNT  i32 (i32.const 0x750014))
  (global $S_LAST_DECODED_VERTEX_BASE i32 (i32.const 0x750018))
  (global $S_LAST_DECODED_FACE_BASE   i32 (i32.const 0x75001c))
  (global $S_ASSET_COUNT              i32 (i32.const 0x750020))
  (global $MODEL_ASSETS               i32 (i32.const 0x750100))
  ...
  ;; ── Exported array base pointers @ 0x700000 ──
  (global (export "model_vertex_x") i32 (i32.const 0x700000))
  (global (export "model_vertex_y") i32 (i32.const 0x708000))
  (global (export "model_vertex_z") i32 (i32.const 0x710000))
  (global (export "model_vertex_group") i32 (i32.const 0x718000))
  (global (export "model_face_a") i32 (i32.const 0x720000))
  (global (export "model_face_b") i32 (i32.const 0x728000))
  (global (export "model_face_c") i32 (i32.const 0x730000))
  (global (export "model_face_color") i32 (i32.const 0x738000))
  (global (export "model_assets") i32 (i32.const 0x740000))
