;; Tor onion-service v3 and EdgeRun identity-fabric surface.
  ...
  (global $m11STANDARD_ID i32 (i32.const 300207))
  (global $m11ABI_VERSION i32 (i32.const 2))
  (global $m11OK i32 (i32.const 0))
  (global $m11ERR_INVALID i32 (i32.const -1))
  (global $m11ERR_BOUNDS i32 (i32.const -2))
  (global $m11ERR_UNSUPPORTED i32 (i32.const -3))
  ...
  (global $m11RELAY_ESTABLISH_INTRO i32 (i32.const 32))
  (global $m11RELAY_ESTABLISH_RENDEZVOUS i32 (i32.const 33))
  (global $m11RELAY_INTRODUCE1 i32 (i32.const 34))
  (global $m11RELAY_INTRODUCE2 i32 (i32.const 35))
  (global $m11RELAY_RENDEZVOUS1 i32 (i32.const 36))
  (global $m11RELAY_RENDEZVOUS2 i32 (i32.const 37))
  (global $RELAY_INTRO_ESTABLISHED i32 (i32.const 38))
  (global $RELAY_RENDEZVOUS_ESTABLISHED i32 (i32.const 39))
  (global $m11RELAY_INTRODUCE_ACK i32 (i32.const 40))
  ...
  (func (export "proto_standard_id") (result i32) (global.get $m11STANDARD_ID))
  (func (export "proto_abi_version") (result i32) (global.get $m11ABI_VERSION))
  ...
  (func (export "tor_hs_validate_onion_address") (param $ptr i32) (param $len i32) (result i32)
    (local $i i32)
    (if (i32.ne (local.get $len) (global.get $ONION_ADDR_LEN)) (then (return (global.get $m11ERR_INVALID))))
    (block $done
      (loop $chars
        ...
        (if (i32.eqz (call $is_base32_onion (i32.load8_u (i32.add (local.get $ptr) (local.get $i)))))
          (then (return (global.get $m11ERR_INVALID))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $chars)))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 56))) (i32.const 46)) (then (return (global.get $m11ERR_INVALID))))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 57))) (i32.const 111)) (then (return (global.get $m11ERR_INVALID))))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 58))) (i32.const 110)) (then (return (global.get $m11ERR_INVALID))))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 59))) (i32.const 105)) (then (return (global.get $m11ERR_INVALID))))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 60))) (i32.const 111)) (then (return (global.get $m11ERR_INVALID))))
    (if (i32.ne (i32.load8_u (i32.add (local.get $ptr) (i32.const 61))) (i32.const 110)) (then (return (global.get $m11ERR_INVALID))))
    (global.get $m11OK))
  ...
  (func $tor_hs_time_period (export "tor_hs_time_period") (param $valid_after_minute i32) (param $period_minutes i32) (param $offset_minutes i32) (result i32)
    (if (i32.eqz (local.get $period_minutes)) (then (return (global.get $m11ERR_INVALID))))
  ...
  (func (export "tor_hs_descriptor_slot") (param $now_minute i32) (param $srv_minute i32) (param $period_minutes i32) (param $slot i32) (result i32)
    (local $tp i32)
    (if (i32.gt_u (local.get $slot) (i32.const 1)) (then (return (global.get $m11ERR_INVALID))))
  ...
  (func (export "tor_hs_build_fetch_path") (param $out i32) (param $blind_b64 i32) (param $blind_len i32) (result i32)
    (if (i32.gt_u (local.get $blind_len) (i32.const 128)) (then (return (global.get $m11ERR_BOUNDS))))
  ...
  (func (export "tor_hs_register_intro_point")
    ...
    (if (i32.ge_u (local.get $count) (global.get $INTRO_MAX_RECORDS)) (then (return (global.get $m11ERR_BOUNDS))))
  ...
  (func (export "tor_hs_build_descriptor_record")
    ...
    (if (i32.gt_u (local.get $intro_count) (global.get $HS_INTRO_MAX)) (then (return (global.get $m11ERR_INVALID))))
  ...
  (func (export "tor_hs_build_introduce_ack") (param $out i32) (param $status i32) (result i32)
    (i32.store8 (local.get $out) (global.get $m11RELAY_INTRODUCE_ACK))
  ...
  (func (export "tor_hs_parse_establish_rendezvous") (param $body i32) (param $body_len i32) (param $out_cookie20 i32) (result i32)
    (if (i32.lt_u (local.get $body_len) (global.get $HS_COOKIE_LEN)) (then (return (global.get $m11ERR_INVALID))))
  ...
  (func (export "tor_hs_build_rendezvous1") (param $out i32) (param $cookie20 i32) (param $handshake i32) (param $handshake_len i32) (result i32)
    (if (i32.gt_u (local.get $handshake_len) (i32.const 477)) (then (return (global.get $m11ERR_BOUNDS))))
    (memory.copy (local.get $out) (local.get $cookie20) (global.get $HS_COOKIE_LEN))
