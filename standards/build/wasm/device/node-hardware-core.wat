  ...
  (func (export "node_hw_pci_address_valid") (param $ptr i32) (param $len i32) (result i32)
    ...
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (local.get $ptr))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 1)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 2)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 3)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 5)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 6)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 8)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 9)))) (i32.const 0)) (then (return (i32.const 0))))
    (if (i32.lt_s (call $m134hex_nibble (i32.load8_u (i32.add (local.get $ptr) (i32.const 11)))) (i32.const 0)) (then (return (i32.const 0))))
    i32.const 1)
