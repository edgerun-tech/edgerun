(module
  ...
  (import "edgerun-core" "LINUX_SYS_X64_UNSHARE"     (global $LX64_UNSHARE i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETNS"       (global $LX64_SETNS i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETHOSTNAME"  (global $LX64_SETHOSTNAME i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETDOMAINNAME" (global $LX64_SETDOMAINNAME i32))
  (import "edgerun-core" "LINUX_SYS_X64_MOUNT"       (global $LX64_MOUNT i32))
  (import "edgerun-core" "LINUX_SYS_X64_PIVOT_ROOT"  (global $LX64_PIVOT_ROOT i32))
  (import "edgerun-core" "LINUX_SYS_X64_UMOUNT2"     (global $LX64_UMOUNT2 i32))
  (import "edgerun-core" "LINUX_SYS_X64_OPEN_TREE"   (global $LX64_OPEN_TREE i32))
  (import "edgerun-core" "LINUX_SYS_X64_MOVE_MOUNT"  (global $LX64_MOVE_MOUNT i32))
  (import "edgerun-core" "LINUX_SYS_X64_MOUNT_SETATTR" (global $LX64_MOUNT_SETATTR i32))
  (import "edgerun-core" "LINUX_SYS_X64_SECCOMP"     (global $LX64_SECCOMP i32))
  (import "edgerun-core" "LINUX_SYS_X64_CAPSET"      (global $LX64_CAPSET i32))
  (import "edgerun-core" "LINUX_SYS_X64_PRCTL"       (global $LX64_PRCTL i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETUID"      (global $LX64_SETUID i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETGID"      (global $LX64_SETGID i32))
  (import "edgerun-core" "LINUX_SYS_X64_SETGROUPS"   (global $LX64_SETGROUPS i32))
  (import "edgerun-core" "LINUX_SYS_X64_PRLIMIT64"   (global $LX64_PRLIMIT64 i32))
  (import "edgerun-core" "LINUX_SYS_X64_SCHED_SETATTR" (global $LX64_SCHED_SETATTR i32))
  (import "edgerun-core" "LINUX_SYS_X64_IOPRIO_SET"  (global $LX64_IOPRIO_SET i32))
  (import "edgerun-core" "LINUX_SYS_X64_UMASK"       (global $LX64_UMASK i32))
  (import "edgerun-core" "LINUX_SYS_X64_KILL"        (global $LX64_KILL i32))
  (import "edgerun-core" "LINUX_SYS_X64_WAIT4"       (global $LX64_WAIT4 i32))
  (import "edgerun-core" "LINUX_SYS_X64_EXECVE"      (global $LX64_EXECVE i32))
  (import "edgerun-core" "LINUX_SYS_X64_CLONE"       (global $LX64_CLONE i32))
  (import "edgerun-core" "LINUX_SYS_X64_BPF"         (global $LX64_BPF i32))
  ;; aarch64 syscall classification constants
  (import "edgerun-core" "LINUX_SYS_AARCH64_UNSHARE"     (global $LA64_UNSHARE i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETNS"       (global $LA64_SETNS i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETHOSTNAME"  (global $LA64_SETHOSTNAME i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETDOMAINNAME" (global $LA64_SETDOMAINNAME i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_MOUNT"       (global $LA64_MOUNT i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_PIVOT_ROOT"  (global $LA64_PIVOT_ROOT i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_UMOUNT2"     (global $LA64_UMOUNT2 i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_OPEN_TREE"       (global $LA64_OPEN_TREE i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_MOVE_MOUNT"      (global $LA64_MOVE_MOUNT i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_MOUNT_SETATTR"   (global $LA64_MOUNT_SETATTR i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SECCOMP"     (global $LA64_SECCOMP i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_CAPSET"          (global $LA64_CAPSET i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_PRCTL"       (global $LA64_PRCTL i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETUID"      (global $LA64_SETUID i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETGID"      (global $LA64_SETGID i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SETGROUPS"   (global $LA64_SETGROUPS i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_PRLIMIT64"   (global $LA64_PRLIMIT64 i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_SCHED_SETATTR" (global $LA64_SCHED_SETATTR i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_IOPRIO_SET"  (global $LA64_IOPRIO_SET i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_UMASK"       (global $LA64_UMASK i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_KILL"        (global $LA64_KILL i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_WAIT4"       (global $LA64_WAIT4 i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_EXECVE"      (global $LA64_EXECVE i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_CLONE"       (global $LA64_CLONE i32))
  (import "edgerun-core" "LINUX_SYS_AARCH64_BPF"         (global $LA64_BPF i32))
