(module
  ...
  (func (export "oci_status_code") (param $ptr i32) (param $len i32) (result i32)
    (if (call $eq_lit (local.get $ptr) (local.get $len) (i32.const 1024) (i32.const 8))
      (then (return (i32.const 0))))
    (if (call $eq_lit (local.get $ptr) (local.get $len) (i32.const 1032) (i32.const 7))
      (then (return (i32.const 1))))
    (if (call $eq_lit (local.get $ptr) (local.get $len) (i32.const 1040) (i32.const 7))
      (then (return (i32.const 2))))
    (if (call $eq_lit (local.get $ptr) (local.get $len) (i32.const 1048) (i32.const 7))
      (then (return (i32.const 3))))
    (if (call $eq_lit (local.get $ptr) (local.get $len) (i32.const 1056) (i32.const 7))
