(module
  ...
  ;; ── Stage function type ──
  ;; (input_pipe, output_pipe, config_ptr, config_len, scratch, scap) -> result
  (type $stage_fn (func (param i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (global $PS_SIZE     i32 (i32.const 12))
  ...
  ;; pipeline_run(desc, input_pipe, output_pipe, scratch, scap) → OK | error
