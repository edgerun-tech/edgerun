(module
  ...
  (import "mux-core" "process_mux_static" (func $mux_static (param i32 i32 i32 i32 i32 i32) (result i32)))
  (import "mux-core" "process_demux_static" (func $demux_static (param i32 i32 i32 i32 i32 i32) (result i32)))
  (import "mux-core" "process_mux_dynamic" (func $mux_dynamic (param i32 i32 i32 i32 i32 i32) (result i32)))
  (import "mux-core" "process_demux_dynamic" (func $demux_dynamic (param i32 i32 i32 i32 i32 i32) (result i32)))
