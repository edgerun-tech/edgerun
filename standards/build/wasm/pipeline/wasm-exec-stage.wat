(module
  ...
  ;; Config layout (4 bytes):
  ;;   +0: func_idx i32  (function index to call; -1 = function 0)

  ;; process_wasm_exec: pipeline stage that loads + executes WASM
  (func (export "process_wasm_exec")
    ...
    ;; 3. Determine function index from config (default 0)
    ...
    ;; 4. Call function
    (local.set $err (call $interp_call (local.get $func_idx) (i32.const 0) (i32.const 0)))
    (if (local.get $err)
      (then (return (i32.sub (i32.const 0) (local.get $err)))))
