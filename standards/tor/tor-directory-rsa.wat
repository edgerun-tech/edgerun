(type $t_8_0 (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (func $m_8_29 (type $t_8_8) (result i32)
    i32.const 300223)
  (table  1 1 funcref)(global $g_8_0 (mut i32) (i32.const 1048576))
  (export "tor_dir_rsa_verify_pkcs1" (func $m_8_0))
  (export "tor_dir_rsa_algorithm_sha256_pkcs1" (func $m_8_27))
  (export "tor_dir_rsa_algorithm_sha1_pkcs1" (func $m_8_28))
  (export "proto_standard_id" (func $m_8_29))
