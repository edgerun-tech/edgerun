...
HS_OUT = ROOT / "build/wasm/app-primitives/tor-hidden-service-full/tor-hidden-service-full.wat"
SPEC_OUT = ROOT / "build/wasm/app-primitives/tor-full-spec/tor-full-spec.wat"
...
def main() -> None:
    HS_OUT.parent.mkdir(parents=True, exist_ok=True)
    SPEC_OUT.parent.mkdir(parents=True, exist_ok=True)
    HS_OUT.write_text(HS_WAT + "\n", encoding="utf-8")
    SPEC_OUT.write_text(SPEC_WAT + "\n", encoding="utf-8")
