;; HPACK Header Block Scan Stage — slot 99
  (func $process_hpack_header_block_scan (export "process_hpack_header_block_scan")
    ...
    (local.set $result (call $hpack_header_block_scan
