;; Deflate Encode Pipeline Stage — slot 28
  ;; Stage type: batch (state=0)
  ;; Input:  raw bytes via input pipe
  ;; Output: deflate-compressed bytes via output pipe
  ;; Calls $deflate_stored_encode from codec/compress.wat

  (func $process_deflate_encode (export "process_deflate_encode")
