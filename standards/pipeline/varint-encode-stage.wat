;; Varint Encode Pipeline Stage — slot 124
  (func $process_varint_encode (export "process_varint_encode")
    ...
    (drop (call $pipe_read (local.get $input) (i32.const 0x3000) (i32.const 8)))
    (local.set $val_lo (i32.load (i32.const 0x3000)))
    (local.set $val_hi (i32.load (i32.const 0x3004)))
    (local.set $result (call $varint_encode_u64 (local.get $val_lo) (local.get $val_hi) (i32.const 0x4000) (i32.const 8192)))
