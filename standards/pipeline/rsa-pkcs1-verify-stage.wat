;; RSA PKCS1 v1.5 Verify Stage — slot 75
  ...
  (func $process_rsa_pkcs1_verify (export "process_rsa_pkcs1_verify")
    ...
    (local.set $digest_len (i32.load (global.get $SCRATCH_BUF)))
    (local.set $status (call $rsa_pkcs1_v15_verify (local.get $hash_alg) (i32.add (global.get $SCRATCH_BUF) (i32.const 4)) (local.get $digest_len) (i32.add (i32.add (global.get $SCRATCH_BUF) (i32.const 4)) (local.get $digest_len)) (local.get $em_len)))
