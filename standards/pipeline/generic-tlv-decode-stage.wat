;; Generic TLV Decode Stage — slot 67
  ...
  (func $process_generic_tlv_decode (export "process_generic_tlv_decode")
    ...
    (local $len_slot i32) (local $read i32) (local $offset i32)
    ...
    (local.set $result (call $generic_tlv_next (i32.add (i32.const 0x3000) (i32.const 4)) (i32.sub (local.get $read) (i32.const 4)) (local.get $offset) (local.get $scratch)))
