;; TLS DNS Name Normalize Stage — slot 102
  (func $process_tls_dns_name_normalize (export "process_tls_dns_name_normalize")
    ...
    (local.set $result (call $tls_dns_name_normalize
